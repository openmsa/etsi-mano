...
if (empty($context['nfvo_service_instance_ref']) || empty($context['vnfm_service_instance_ref'])) {
	task_exit(FAILED, "VNFM or/and NFVO service instance are failed");
}
...
$process_name = "Process/ETSI-MANO/NFV/Abstract_NSD/Process_Scale_out_NS";
...
task_exit(ENDED, "NS Auto-Scale-out OK");
