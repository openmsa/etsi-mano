...
public class DnsZoneVT extends VnfVtBase<DnsZoneTask> {
	...
	public List<NamedDependency> getNameDependencies() {
		return Arrays.asList(new NamedDependency(Network.class, getParameters().getVnfVl().getToscaName()));
	}

	@Override
	public List<NamedDependency> getNamedProduced() {
		return Arrays.asList(new NamedDependency(DnsZone.class, getParameters().getToscaName()));
	}
