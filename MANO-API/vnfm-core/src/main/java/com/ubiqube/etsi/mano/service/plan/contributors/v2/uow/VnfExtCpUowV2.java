 ...
 *
 */
public class VnfExtCpUowV2 implements UnitOfWork<ExternalCpTask> {
	...
	public String execute(final Context context) {
		...
		return vim.network(vimConnectionInformation).createRouter(task.getParameters().getAlias(), networkId, extNetwork);
	}
