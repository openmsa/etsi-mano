...
public class SpelTest {
	...
	void testName() throws Exception {
		...
		parser.parseExpression("filter.vnfProductsFromProviders[0].operationalState").setValue(modelContext, OperationalStateEnum.ENABLED);
		// parser.parseExpression("filter.vnfProductsFromProviders[0].operationalState[1]").setValue(modelContext, "DISABLED");
		...
		// BeanUtils.setProperty(subsJson, "filter.vnfProductsFromProviders.0.vnfProvider", "hello");
		// PropertyUtils.setNestedProperty(subsJson, "filter.vnfProductsFromProviders.0.vnfProvider", "value");
