...
public class VnfLcmSol002Api implements VnfLcmSol002 {
	...
	@Autowired
	public VnfLcmSol002Api(OrchestrationService _orchestrationService, VnfInstancesRepository _vnfInstancesRepository, VnfPackageRepository _vnfPackageRepository) {
