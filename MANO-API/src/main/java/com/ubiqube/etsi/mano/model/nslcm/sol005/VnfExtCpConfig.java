...
public class VnfExtCpConfig {
	 ...
	 * and \"cpProtocolData\": * The \"linkPortId\" and \"cpProtocolData\"
	 * attributes shall both be absent for the deletion of an existing external CP
	 * instance addressed by cpInstanceId. * At least one of these attributes shall
	 * be present for a to-be-created external CP instance or an existing external
	 * CP instance. * If the \"linkPortId\" attribute is absent, the VNFM shall
	 * create a link port. * If the \"cpProtocolData\" attribute is absent, the
	 ...
	 * the resource representing the link port. * If both \"cpProtocolData\" and
	 ...
	 * \"linkPortId\" and \"cpProtocolData\": * The \"linkPortId\" and
	 * \"cpProtocolData\" attributes shall both be absent for the deletion of an
	 * existing external CP instance addressed by cpInstanceId. * At least one of
	 * these attributes shall be present for a to-be-created external CP instance or
	 * an existing external CP instance. * If the \"linkPortId\" attribute is
	 * absent, the VNFM shall create a link port. * If the \"cpProtocolData\"
	 ...
	 * port. * If both \"cpProtocolData\" and \"linkportId\" are provided, the API
