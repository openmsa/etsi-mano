...
public interface ThresholdsSol005 {
	...
	ResponseEntity<List<Object>> thresholdsGet(@RequestHeader("Accept") String accept, @RequestParam("filter") String filter);
	...
	ResponseEntity<ThresholdsPostResponse> thresholdsPost(@Valid CreateThresholdRequest createThresholdRequest, @RequestHeader("Accept") String accept, @RequestHeader("Content-Type") String contentType);
	...
	void thresholdsThresholdIdDelete(@PathVariable("thresholdId") String thresholdId, @RequestHeader("Accept") String accept);
	...
	ResponseEntity<ThresholdsPostResponse> thresholdsThresholdIdGet(@PathVariable("thresholdId") String thresholdId, @RequestHeader("Accept") String accept);
