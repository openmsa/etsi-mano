...
public interface NsLcmSubscriptionsSol005 {
	...
	ResponseEntity<List<Object>> subscriptionsGet(@RequestHeader("Accept") String accept);
	...
	ResponseEntity<SubscriptionsPost> subscriptionsPost(@RequestHeader("Accept") String accept, @RequestHeader("Content-Type") String contentType, @Valid SubscriptionsPostQuery body);
	...
	ResponseEntity<SubscriptionsPost> subscriptionsSubscriptionIdGet(@PathVariable("subscriptionId") String subscriptionId, @RequestHeader("Accept") String accept);
