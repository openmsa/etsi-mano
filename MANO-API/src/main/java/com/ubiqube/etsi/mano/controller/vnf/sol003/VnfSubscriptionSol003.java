...
public interface VnfSubscriptionSol003 {
	...
	void vnfPackageChangeNotificationPost(@Nonnull @RequestBody NotificationsMessage notificationsMessage);
	...
	void vnfPackageOnboardingNotificationPost(@Nonnull @RequestBody NotificationsMessage notificationsMessage);
