...
public class NsLcmSol005Api extends BaseApi implements NsLcmSol005 {
	...
	public void nslcmV1NsLcmOpOccsNsLcmOpOccIdCancelPost(@PathParam("nsLcmOpOccId") String nsLcmOpOccId, @HeaderParam("Accept") String accept, @HeaderParam("Content-Type") String contentType, NslcmV1NsLcmOpOccsNsLcmOpOccIdCancelPostQuery body) {
		// TODO: Implement...
