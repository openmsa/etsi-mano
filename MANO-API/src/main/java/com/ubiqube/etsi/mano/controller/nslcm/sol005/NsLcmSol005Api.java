...
public class NsLcmSol005Api implements NsLcmSol005 {
	...
	public ResponseEntity<SubscriptionsPost> subscriptionsPost(@HeaderParam("Accept") String accept, @HeaderParam("Content-Type") String contentType, SubscriptionsPostQuery body) {
		// TODO: Implement...
