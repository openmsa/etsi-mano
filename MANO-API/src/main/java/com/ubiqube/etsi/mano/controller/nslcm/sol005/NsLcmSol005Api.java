...
public class NsLcmSol005Api implements NsLcmSol005 {
	...
	public void nslcmV1NsLcmOpOccsNsLcmOpOccIdCancelPost(@PathVariable("nsLcmOpOccId") String nsLcmOpOccId, @RequestHeader("Accept") String accept, @RequestHeader("Content-Type") String contentType, NslcmV1NsLcmOpOccsNsLcmOpOccIdCancelPostQuery body) {
		// TODO: Implement...
	...
	public ResponseEntity<SubscriptionsPost> subscriptionsPost(@RequestHeader("Accept") String accept, @RequestHeader("Content-Type") String contentType, SubscriptionsPostQuery body) {
		// TODO: Implement...
	...
	public void uRIIsProvidedByTheClientWhenCreatingTheSubscriptionNsIdentifierCreationNotificationPost(NsIdentifierCreationNotification nsIdentifierCreationNotification, @RequestHeader("Accept") String accept, @RequestHeader("Content-Type") String contentType) {
		// TODO: Implement...
	...
	public void uRIIsProvidedByTheClientWhenCreatingTheSubscriptionNsIdentifierDeletionNotificationPost(NsIdentifierDeletionNotification nsIdentifierDeletionNotification, @RequestHeader("Accept") String accept, @RequestHeader("Content-Type") String contentType) {
		// TODO: Implement...
	...
	public void uRIIsProvidedByTheClientWhenCreatingTheSubscriptionNsLcmOperationOccurrenceNotificationPost(NsLcmOperationOccurrenceNotification nsLcmOperationOccurrenceNotification, @RequestHeader("Accept") String accept, @RequestHeader("Content-Type") String contentType) {
		// TODO: Implement...
