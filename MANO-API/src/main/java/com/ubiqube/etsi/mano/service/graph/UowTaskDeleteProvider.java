...
public class UowTaskDeleteProvider implements TaskProvider<UnitOfWork, String> {
	...
	public UowTaskDeleteProvider(final VimConnectionInformation vimConnectionInformation, final Vim vim, final ResourceHandleEntityJpa _resourceHandleEntityJpa) {
		super();
	...
	public Task<UnitOfWork, String> provideTask(final UnitOfWork uaow) {
		...
		return new UowExecDeleteTask(vimConnectionInformation, vim, uaow, resourceHandleEntityJpa, context);
	}
