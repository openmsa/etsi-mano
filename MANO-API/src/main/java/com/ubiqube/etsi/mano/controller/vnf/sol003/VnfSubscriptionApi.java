...
public class VnfSubscriptionApi implements VnfSubscription {
	...
	public List<SubscriptionsPkgmSubscription> subscriptionsGet(@RequestHeader("Accept") String accept, @RequestParam("filter") String filter) {
	...
	public List<InlineResponse2001> subscriptionsPost(@RequestHeader("Accept") String accept, @RequestHeader("Content-Type") String contentType, @RequestBody SubscriptionsPostQuery subscriptionsPostQuery) {
		// Job
