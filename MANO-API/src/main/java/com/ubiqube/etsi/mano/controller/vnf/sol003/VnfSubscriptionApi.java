...
public class VnfSubscriptionApi implements VnfSubscription {
	...
	public List<InlineResponse2001> subscriptionsPost(@HeaderParam("Accept") String accept, @HeaderParam("Content-Type") String contentType, SubscriptionsPostQuery subscriptionsPostQuery) {
		// Job
