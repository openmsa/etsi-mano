...
public interface PmJobsSol005 {
	...
	ResponseEntity<PmJobsPmJobIdReportsReportIdGetResponse> pmJobsPmJobIdReportsReportIdGet(@PathVariable("pmJobId") String pmJobId, @PathVariable("reportId") String reportId, @RequestHeader("Accept") String accept);
