...
public interface NsPerfoSol005 {
	...
	public ResponseEntity<List<Object>> pmJobsGet(@RequestHeader("Accept") String accept, @RequestHeader("Content-Type") String contentType, @RequestParam("filter") String filter, @RequestParam("all_fields") String allFields, @RequestParam("include") String include, @RequestParam("exclude") String exclude, @RequestParam("exclude_default") String excludeDefault);
	...
	public void pmJobsPmJobIdDelete(@PathVariable("pmJobId") String pmJobId);
	...
	public ResponseEntity<PmJobsPostResponse> pmJobsPmJobIdGet(@PathVariable("pmJobId") String pmJobId, @RequestHeader("Accept") String accept);
	...
	public ResponseEntity<PmJobsPmJobIdReportsReportIdGetResponse> pmJobsPmJobIdReportsReportIdGet(@PathVariable("pmJobId") String pmJobId, @PathVariable("reportId") String reportId, @RequestHeader("Accept") String accept);
	...
	public ResponseEntity<PmJobsPostResponse> pmJobsPost(@Valid CreatePmJobRequest createPmJobRequest, @RequestHeader("Accept") String accept, @RequestHeader("Content-Type") String contentType);
	...
	public ResponseEntity<List<Object>> subscriptionsGet(@RequestHeader("Accept") String accept, @RequestParam("filter") String filter);
	...
	public ResponseEntity<SubscriptionsPostResponse> subscriptionsPost(@RequestHeader("Accept") String accept, @RequestHeader("Content-Type") String contentType, @Valid SubscriptionsPostQuery body);
	...
	public void subscriptionsSubscriptionIdDelete(@PathVariable("subscriptionId") String subscriptionId, @RequestHeader("Accept") String accept);
	...
	public ResponseEntity<SubscriptionsPostResponse> subscriptionsSubscriptionIdGet(@PathVariable("subscriptionId") String subscriptionId, @RequestHeader("Accept") String accept);
	...
	public ResponseEntity<List<Object>> thresholdsGet(@RequestHeader("Accept") String accept, @RequestParam("filter") String filter);
	...
	public ResponseEntity<ThresholdsPostResponse> thresholdsPost(@Valid CreateThresholdRequest createThresholdRequest, @RequestHeader("Accept") String accept, @RequestHeader("Content-Type") String contentType);
	...
	public void thresholdsThresholdIdDelete(@PathVariable("thresholdId") String thresholdId, @RequestHeader("Accept") String accept);
	...
	public ResponseEntity<ThresholdsPostResponse> thresholdsThresholdIdGet(@PathVariable("thresholdId") String thresholdId, @RequestHeader("Accept") String accept);
	...
	public void uRIIsProvidedByTheClientWhenCreatingTheSubscriptionPerformanceInformationAvailableNotificationPost(@Valid PerformanceInformationAvailableNotification performanceInformationAvailableNotification, @RequestHeader("Accept") String accept, @RequestHeader("Content-Type") String contentType);
	...
	public void uRIIsProvidedByTheClientWhenCreatingTheSubscriptionThresholdCrossedNotificationGet(@RequestHeader("Accept") String accept);
	...
	public void uRIIsProvidedByTheClientWhenCreatingTheSubscriptionThresholdCrossedNotificationPost(@Valid ThresholdCrossedNotification thresholdCrossedNotification, @RequestHeader("Accept") String accept, @RequestHeader("Content-Type") String contentType);
}
