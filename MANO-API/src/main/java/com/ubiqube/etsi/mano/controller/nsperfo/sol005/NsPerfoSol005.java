...
public interface NsPerfoSol005 {
	...
	public PmJobsPostResponse pmJobsPmJobIdGet(@PathVariable("pmJobId") String pmJobId, @HeaderParam("Accept") String accept);
	...
	public PmJobsPmJobIdReportsReportIdGetResponse pmJobsPmJobIdReportsReportIdGet(@PathVariable("pmJobId") String pmJobId, @PathVariable("reportId") String reportId, @HeaderParam("Accept") String accept);
	...
	public ThresholdsPostResponse thresholdsThresholdIdGet(@PathVariable("thresholdId") String thresholdId, @HeaderParam("Accept") String accept);
