...
public interface NsPerfoSol005 {
	...
	public ResponseEntity<PmJobsPostResponse> pmJobsPmJobIdGet(@PathVariable("pmJobId") String pmJobId, @HeaderParam("Accept") String accept);
	...
	public ResponseEntity<PmJobsPmJobIdReportsReportIdGetResponse> pmJobsPmJobIdReportsReportIdGet(@PathVariable("pmJobId") String pmJobId, @PathVariable("reportId") String reportId, @HeaderParam("Accept") String accept);
	...
	public ResponseEntity<PmJobsPostResponse> pmJobsPost(@Valid CreatePmJobRequest createPmJobRequest, @HeaderParam("Accept") String accept, @HeaderParam("Content-Type") String contentType);
	...
	public ResponseEntity<List<Object>> subscriptionsGet(@HeaderParam("Accept") String accept, @QueryParam("filter") String filter);
	...
	public ResponseEntity<SubscriptionsPostResponse> subscriptionsPost(@HeaderParam("Accept") String accept, @HeaderParam("Content-Type") String contentType, @Valid SubscriptionsPostQuery body);
	...
	public void subscriptionsSubscriptionIdDelete(@PathVariable("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept);
	...
	public ResponseEntity<SubscriptionsPostResponse> subscriptionsSubscriptionIdGet(@PathVariable("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept);
	...
	public ResponseEntity<List<Object>> thresholdsGet(@HeaderParam("Accept") String accept, @QueryParam("filter") String filter);
	...
	public ResponseEntity<ThresholdsPostResponse> thresholdsPost(@Valid CreateThresholdRequest createThresholdRequest, @HeaderParam("Accept") String accept, @HeaderParam("Content-Type") String contentType);
	...
	public void thresholdsThresholdIdDelete(@PathVariable("thresholdId") String thresholdId, @HeaderParam("Accept") String accept);
	...
	public ResponseEntity<ThresholdsPostResponse> thresholdsThresholdIdGet(@PathVariable("thresholdId") String thresholdId, @HeaderParam("Accept") String accept);
