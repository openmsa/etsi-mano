...
public class ComputeCont implements PlanContributor<VnfPackage, VnfBlueprint, VnfTask, TestParameters> {
	...
	public List<UnitOfWork<VnfTask, TestParameters>> convertTasksToExecNode(final Set<VnfTask> tasks, final VnfBlueprint blueprint) {
		...
		final UnitOfWork<VnfTask, TestParameters> uow = new CompTestUow();
		ret.add(uow);
		return ret;
	}
