...
public interface VnfInstanceGenericFrontController {
	...
	<U> ResponseEntity<Void> scaleToLevel(@NotNull UUID vnfInstanceId, U body, Function<U, String> getSelfLink);

	<U> ResponseEntity<Void> scale(@NotNull UUID vnfInstanceId, U body, Function<U, String> getSelfLink);
	...
	<U> ResponseEntity<Void> operate(@NotNull UUID vnfInstanceId, U body, Function<U, String> getSelfLink);

	<U> ResponseEntity<Void> instantiate(@NotNull UUID vnfInstanceId, U body, Function<U, String> getSelfLink);
	...
	<U> ResponseEntity<Void> createSnapshot(@NotNull UUID vnfInstanceId, U object, Function<U, String> getSelfLink);

	<U> ResponseEntity<Void> changeVnfPkg(@NotNull UUID vnfInstanceId, U object, Function<U, String> getSelfLink);

	<U> ResponseEntity<Void> changeFlavour(@NotNull UUID vnfInstanceId, U object, Function<U, String> getSelfLink);

	<U> ResponseEntity<Void> changeExtConn(@NotNull UUID vnfInstanceId, U object, Function<U, String> getSelfLink);
