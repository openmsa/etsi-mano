 ...
 */
@Service
public class VnfSubscriptionSol003FrontController {
	...
	public VnfSubscriptionSol003FrontController(final VnfSubscriptionManagement _vnfSubscriptionManagement, final MapperFacade _mapper, final Notifications _notifications) {
	...
	public ResponseEntity<Void> delete(final @Nonnull String subscriptionId) {
