 ...
 */
@Service
public class PolicyFrontController {
	private final PolicyController policyController;
	private final MapperFacade mapper;

	public PolicyFrontController(final PolicyController policyController, final MapperFacade mapper) {
		super();
		this.policyController = policyController;
		this.mapper = mapper;
	}

	public <U> ResponseEntity<String> search(final MultiValueMap<String, String> requestParams, @Valid final String nextpageOpaqueMarker, final Class<U> clazz, final Consumer<U> makeLinks) {
	...
	public <U> ResponseEntity<U> create(@Valid final Object body, final Class<U> clazz, final Consumer<U> makeLinks) {
