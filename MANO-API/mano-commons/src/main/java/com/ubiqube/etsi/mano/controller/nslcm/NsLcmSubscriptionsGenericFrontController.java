 ...
 */
@Service
public class NsLcmSubscriptionsGenericFrontController {
	...
	public NsLcmSubscriptionsGenericFrontController(final SubscriptionService _subscriptionService, final MapperFacade _mapper, final Notifications _notifications) {
