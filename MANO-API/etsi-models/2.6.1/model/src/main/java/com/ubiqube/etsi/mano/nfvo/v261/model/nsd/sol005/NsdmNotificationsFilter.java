...
public class NsdmNotificationsFilter {
	...
	/**
	 * Match the NSD invariant identifier which is allocated by the NSD designer and
	...
	/**
	 * Match the NsdInfo identifier for the nested NSD referenced by the on-boarded
	 * NSD.
	 * 
