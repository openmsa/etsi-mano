...
import com.ubiqube.etsi.mano.vnfm.v261.model.vrqan.AlarmListRebuiltNotificationLinks;
 ...
 */
@ApiModel(description = "This type represents a notification that the alarm list has been rebuilt, e.g. if the VNFM detects its storage holding the alarm list is corrupted. The notification shall be triggered by the VNFM when the alarm list has been rebuilt. ")
@Validated
