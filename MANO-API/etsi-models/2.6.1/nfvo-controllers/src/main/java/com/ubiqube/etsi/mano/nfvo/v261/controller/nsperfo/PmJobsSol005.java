...
public interface PmJobsSol005 {
	...
	ResponseEntity<PmJobsPostResponse> pmJobsPmJobIdGet(@PathVariable("pmJobId") String pmJobId);
	...
	ResponseEntity<PmJobsPostResponse> pmJobsPost(@Valid CreatePmJobRequest createPmJobRequest);
