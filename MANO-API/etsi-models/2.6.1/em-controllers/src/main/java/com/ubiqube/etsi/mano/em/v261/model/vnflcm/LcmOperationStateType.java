...
/**
 * STARTING: The LCM operation is starting. PROCESSING: The LCM operation is
 ...
 * as it is determined that such action won't succeed. ROLLING_BACK: The LCM
 * operation is currently being rolled back. ROLLED_BACK: The LCM operation has
 * been successfully rolled back, i.e. The state of the VNF prior to the
