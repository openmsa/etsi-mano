...
public interface Configuration281Sol002Api {
    ...
    Logger log = LoggerFactory.getLogger(Configuration281Sol002Api.class);
    ...
    default ResponseEntity<VnfConfiguration> configurationGet(@ApiParam(value = "Version of the API requested to use when responding to this request. " ,required=true) @RequestHeader(value="Version", required=true) String version,@ApiParam(value = "The authorization token for the request. Reference: IETF RFC 7235 " ) @RequestHeader(value="Authorization", required=false) String authorization) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("{  \"vnfConfigurationData\" : {    \"extCpConfig\" : [ {      \"addresses\" : [ {        \"address\" : {          \"macAddress\" : { },          \"ipAddress\" : { }        },        \"useDynamicAddress\" : true,        \"port\" : 0      }, {        \"address\" : {          \"macAddress\" : { },          \"ipAddress\" : { }        },        \"useDynamicAddress\" : true,        \"port\" : 0      } ],      \"cpdId\" : { },      \"cpId\" : { }    }, {      \"addresses\" : [ {        \"address\" : {          \"macAddress\" : { },          \"ipAddress\" : { }        },        \"useDynamicAddress\" : true,        \"port\" : 0      }, {        \"address\" : {          \"macAddress\" : { },          \"ipAddress\" : { }        },        \"useDynamicAddress\" : true,        \"port\" : 0      } ],      \"cpdId\" : { },      \"cpId\" : { }    } ],    \"vnfSpecificData\" : { }  },  \"vnfcConfigurationData\" : [ {    \"intCpConfig\" : [ {      \"addresses\" : [ {        \"address\" : {          \"macAddress\" : { },          \"ipAddress\" : { }        },        \"useDynamicAddress\" : true,        \"port\" : 0      }, {        \"address\" : {          \"macAddress\" : { },          \"ipAddress\" : { }        },        \"useDynamicAddress\" : true,        \"port\" : 0      } ],      \"cpdId\" : { },      \"cpId\" : { }    }, {      \"addresses\" : [ {        \"address\" : {          \"macAddress\" : { },          \"ipAddress\" : { }        },        \"useDynamicAddress\" : true,        \"port\" : 0      }, {        \"address\" : {          \"macAddress\" : { },          \"ipAddress\" : { }        },        \"useDynamicAddress\" : true,        \"port\" : 0      } ],      \"cpdId\" : { },      \"cpId\" : { }    } ]  }, {    \"intCpConfig\" : [ {      \"addresses\" : [ {        \"address\" : {          \"macAddress\" : { },          \"ipAddress\" : { }        },        \"useDynamicAddress\" : true,        \"port\" : 0      }, {        \"address\" : {          \"macAddress\" : { },          \"ipAddress\" : { }        },        \"useDynamicAddress\" : true,        \"port\" : 0      } ],      \"cpdId\" : { },      \"cpId\" : { }    }, {      \"addresses\" : [ {        \"address\" : {          \"macAddress\" : { },          \"ipAddress\" : { }        },        \"useDynamicAddress\" : true,        \"port\" : 0      }, {        \"address\" : {          \"macAddress\" : { },          \"ipAddress\" : { }        },        \"useDynamicAddress\" : true,        \"port\" : 0      } ],      \"cpdId\" : { },      \"cpId\" : { }    } ]  } ]}", VnfConfiguration.class), HttpStatus.NOT_IMPLEMENTED);
                } catch (IOException e) {
    ...
    default ResponseEntity<VnfConfigModifications> configurationPatch(@ApiParam(value = "Version of the API requested to use when responding to this request. " ,required=true) @RequestHeader(value="Version", required=true) String version,@ApiParam(value = "The parameter for the configuration modification, as defined in clause 9.5.2.2. " ,required=true )  @Valid @RequestBody VnfConfigModifications configModifications,@ApiParam(value = "The authorization token for the request. Reference: IETF RFC 7235 " ) @RequestHeader(value="Authorization", required=false) String authorization) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("{  \"vnfConfigurationData\" : {    \"extCpConfig\" : [ {      \"addresses\" : [ {        \"address\" : {          \"macAddress\" : { },          \"ipAddress\" : { }        },        \"useDynamicAddress\" : true,        \"port\" : 0      }, {        \"address\" : {          \"macAddress\" : { },          \"ipAddress\" : { }        },        \"useDynamicAddress\" : true,        \"port\" : 0      } ],      \"cpdId\" : { },      \"cpId\" : { }    }, {      \"addresses\" : [ {        \"address\" : {          \"macAddress\" : { },          \"ipAddress\" : { }        },        \"useDynamicAddress\" : true,        \"port\" : 0      }, {        \"address\" : {          \"macAddress\" : { },          \"ipAddress\" : { }        },        \"useDynamicAddress\" : true,        \"port\" : 0      } ],      \"cpdId\" : { },      \"cpId\" : { }    } ],    \"vnfSpecificData\" : { }  },  \"vnfcConfigurationData\" : [ {    \"intCpConfig\" : [ {      \"addresses\" : [ {        \"address\" : {          \"macAddress\" : { },          \"ipAddress\" : { }        },        \"useDynamicAddress\" : true,        \"port\" : 0      }, {        \"address\" : {          \"macAddress\" : { },          \"ipAddress\" : { }        },        \"useDynamicAddress\" : true,        \"port\" : 0      } ],      \"cpdId\" : { },      \"cpId\" : { }    }, {      \"addresses\" : [ {        \"address\" : {          \"macAddress\" : { },          \"ipAddress\" : { }        },        \"useDynamicAddress\" : true,        \"port\" : 0      }, {        \"address\" : {          \"macAddress\" : { },          \"ipAddress\" : { }        },        \"useDynamicAddress\" : true,        \"port\" : 0      } ],      \"cpdId\" : { },      \"cpId\" : { }    } ]  }, {    \"intCpConfig\" : [ {      \"addresses\" : [ {        \"address\" : {          \"macAddress\" : { },          \"ipAddress\" : { }        },        \"useDynamicAddress\" : true,        \"port\" : 0      }, {        \"address\" : {          \"macAddress\" : { },          \"ipAddress\" : { }        },        \"useDynamicAddress\" : true,        \"port\" : 0      } ],      \"cpdId\" : { },      \"cpId\" : { }    }, {      \"addresses\" : [ {        \"address\" : {          \"macAddress\" : { },          \"ipAddress\" : { }        },        \"useDynamicAddress\" : true,        \"port\" : 0      }, {        \"address\" : {          \"macAddress\" : { },          \"ipAddress\" : { }        },        \"useDynamicAddress\" : true,        \"port\" : 0      } ],      \"cpdId\" : { },      \"cpId\" : { }    } ]  } ],  \"vnfcConfigurationDataDeleteIds\" : [ { }, { } ]}", VnfConfigModifications.class), HttpStatus.NOT_IMPLEMENTED);
                } catch (IOException e) {
                    log.error("Couldn't serialize response for content type application/json", e);
                    return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
                }
