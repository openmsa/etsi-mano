 ...
 */
package com.ubiqube.etsi.mano.em.v281.controller;
...
public class VnfmSwaggerDocumentationConfig281 {
	...
	ApiInfo apiInfo() {
		return new ApiInfoBuilder()
				...
				.termsOfServiceUrl("")
				.version("2.8.1-impl:etsi.org:ETSI_NFV_OpenAPI:1")
				.contact(new Contact("", "", ""))
				.build();
	}

	@Bean
	public Docket customImplementationVnfm281() {
		return new Docket(DocumentationType.SWAGGER_2)
				.pathProvider(new CustomPathProvider())
				.groupName("vnfm-etsi-mano-2.8.1")
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.ubiqube.etsi.mano.vnfm.v281"))
				.build()
