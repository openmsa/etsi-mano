...
import com.ubiqube.etsi.mano.nfvo.v281.model.nslcm.ResourceHandle;
import com.ubiqube.etsi.mano.nfvo.v281.model.nslcm.VnfcResourceInfoVnfcCpInfo;
...
public class VnfcResourceInfo   {
  ...
  **/
  ...
  /**
   * Reference to the applicable VDU in the VNFD. see note 1. NOTE 1: ETSI GS NFV-SOL 001 specifies the structure and format of the VNFD based on TOSCA specifications. 
   * @return vduId
  **/
  @ApiModelProperty(required = true, value = "Reference to the applicable VDU in the VNFD. see note 1. NOTE 1: ETSI GS NFV-SOL 001 specifies the structure and format of the VNFD based on TOSCA specifications. ")
  @NotNull
