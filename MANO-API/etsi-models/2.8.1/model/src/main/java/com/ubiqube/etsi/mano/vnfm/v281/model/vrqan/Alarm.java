...
import com.ubiqube.etsi.mano.vnfm.v281.model.vrqan.AlarmLinks;
import com.ubiqube.etsi.mano.vnfm.v281.model.vrqan.EventType;
import com.ubiqube.etsi.mano.vnfm.v281.model.vrqan.FaultyResourceInfo;
import com.ubiqube.etsi.mano.vnfm.v281.model.vrqan.PerceivedSeverityType;
...
public class Alarm   {
  ...
  **/
  @ApiModelProperty(value = "The virtualised resources that are causing the VNF fault. Shall be present if the alarm affects virtualised resources. ")
  ...
  **/
   ...
   * @return isRootCause
  **/
  @ApiModelProperty(required = true, value = "Attribute indicating if this fault is the root for other correlated alarms. If true, then the alarms listed in the attribute \"correlatedAlarmIds\" are caused by this fault. ")
  @NotNull
