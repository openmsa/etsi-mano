...
import com.ubiqube.etsi.mano.vnfm.v281.model.vnflcm.CpProtocolInfo;
...
public class VnfcResourceInfoVnfcCpInfo   {
  ...
  **/
  @ApiModelProperty(value = "Identifier of the \"VnfLinkPortInfo\" structure in the \"VnfVirtualLinkResourceInfo\" structure. Shall be present if the CP is associated to a link port  on an internal VL of the VNF instance and shall be absent otherwise. ")
