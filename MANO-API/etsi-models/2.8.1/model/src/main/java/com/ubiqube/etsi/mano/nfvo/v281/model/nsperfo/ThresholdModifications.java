 ...
 * provisions defined in Table 7.5.2.11-1.
 */
...
public class ThresholdModifications {
	 ...
	 * permitted. At least one of the attributes defined in this type shall be
	 * present in request bodies.
	 *
	 * @return callbackUri
	 **/
	 ...
	 * according to the rules of JSON Merge Patch (see IETF RFC 7396). This
	 * attribute shall not be present in response bodies. At least one of the
