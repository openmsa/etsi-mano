...
public class VnfInfoModifications {
	...
	public VnfInfoModifications vimConnectionInfoDeleteIds(final List<String> vimConnectionInfoDeleteIds) {
		this.vimConnectionInfoDeleteIds = vimConnectionInfoDeleteIds;
		return this;
	}

	public VnfInfoModifications addVimConnectionInfoDeleteIdsItem(final String vimConnectionInfoDeleteIdsItem) {
	...
	/**
	 * If present, this attribute signals the deletion of certain entries in the \"vimConnectionInfo\" attribute array in \"VnfInstance\".
	 *
	 * @return vimConnectionInfoDeleteIds
	 **/
	@ApiModelProperty(value = "If present, this attribute signals the deletion of certain entries in the \"vimConnectionInfo\" attribute array in \"VnfInstance\". ")

	public List<String> getVimConnectionInfoDeleteIds() {
		return vimConnectionInfoDeleteIds;
	}

	public void setVimConnectionInfoDeleteIds(final List<String> vimConnectionInfoDeleteIds) {
		this.vimConnectionInfoDeleteIds = vimConnectionInfoDeleteIds;
	}
	...
	/**
	 * If present, this attribute signals modifications of the \"vnfdVersion\" attribute in \"VnfInstance\". If present, this attribute (which depends on the value of the \"vnfPkgId\" attribute) was modified implicitly following a request to modify the \"vnfPkgId\" attribute, by copying the value of this attribute from the VNFD in the VNF Package identified by the \"vnfPkgId” attribute.
	 *
	 * @return vnfdVersion
	 **/
	...
	public boolean equals(final java.lang.Object o) {
		...
		return Objects.equals(this.vnfInstanceName, vnfInfoModifications.vnfInstanceName) &&
				...
				Objects.equals(this.vimConnectionInfoDeleteIds, vnfInfoModifications.vimConnectionInfoDeleteIds) &&
	...
	@Override
	public int hashCode() {
		return Objects.hash(vnfInstanceName, vnfInstanceDescription, vnfConfigurableProperties, metadata, extensions, vimConnectionInfo, vimConnectionInfoDeleteIds, vnfdId, vnfProvider, vnfProductName, vnfSoftwareVersion, vnfdVersion);
	}
