...
import com.ubiqube.etsi.mano.nfvo.v281.model.nsperfo.KeyValuePairs;
...
public class PerformanceReportPerformanceValues   {
  ...
  **/
  ...
  /**
   * Measurement context information related to the measured value. The set of applicable keys is defined per measurement in the related \"Measurement Context\" in clause 7.3 of ETSI GS NFV-IFA 027. 
   * @return context
  **/
  @ApiModelProperty(value = "Measurement context information related to the measured value. The set of applicable keys is defined per measurement in the related \"Measurement Context\" in clause 7.3 of ETSI GS NFV-IFA 027. ")
