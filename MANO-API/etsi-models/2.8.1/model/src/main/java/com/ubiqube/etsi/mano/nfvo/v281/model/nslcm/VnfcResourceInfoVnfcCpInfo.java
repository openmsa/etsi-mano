...
public class VnfcResourceInfoVnfcCpInfo   {
  ...
  **/
  ...
  /**
   * Identifier of the VDU CPD, cpdId, in the VNFD. see note 1. NOTE 1: ETSI GS NFV-SOL 001 specifies the structure and format of the VNFD based on TOSCA specifications. 
   * @return cpdId
  **/
  @ApiModelProperty(required = true, value = "Identifier of the VDU CPD, cpdId, in the VNFD. see note 1. NOTE 1: ETSI GS NFV-SOL 001 specifies the structure and format of the VNFD based on TOSCA specifications. ")
  @NotNull
