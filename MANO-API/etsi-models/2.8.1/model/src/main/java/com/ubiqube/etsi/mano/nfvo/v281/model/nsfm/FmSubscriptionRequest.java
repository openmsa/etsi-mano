...
import com.ubiqube.etsi.mano.nfvo.v281.model.nsfm.FmNotificationsFilter;
import com.ubiqube.etsi.mano.nfvo.v281.model.nsfm.SubscriptionAuthentication;
...
public class FmSubscriptionRequest   {
  ...
  **/
  ...
  /**
   * Authentication parameters to configure the use of Authorization when sending notifications corresponding to this subscription, as defined in clause 4.5.3.4.8.3.4 of ETSI GS NFV SOL 013. This attribute shall only be present if the subscriber requires authorization of notifications. 
   * @return authentication
  **/
  @ApiModelProperty(value = "Authentication parameters to configure the use of Authorization when sending notifications corresponding to this subscription, as defined in clause 4.5.3.4.8.3.4 of ETSI GS NFV SOL 013. This attribute shall only be present if the subscriber requires authorization of notifications. ")
