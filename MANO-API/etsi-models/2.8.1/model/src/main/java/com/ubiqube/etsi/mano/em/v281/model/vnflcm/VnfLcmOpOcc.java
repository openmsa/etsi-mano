...
public class VnfLcmOpOcc   {
  ...
  **/
  ...
  public VnfLcmOpOcc stateEnteredTime(String stateEnteredTime) {
  ...
  **/
  ...
  public VnfLcmOpOcc startTime(String startTime) {
  ...
  **/
  ...
  /**
   * Information about the changed VNF instance information, including VNF configurable properties, if applicable. This allows the NFVO/API consumer to obtain the information contained in the latest \"result\" notification if it has not received it due to an error or a wrongly configured subscription filter. 
   * @return changedInfo
  **/
  ...
  /**
   * Information about changed external connectivity, if applicable. This allows the NFVO/API consumer to obtain the information contained in the latest \"result\" notification if it has not received it due to an error or a wrongly configured subscription filter. 
