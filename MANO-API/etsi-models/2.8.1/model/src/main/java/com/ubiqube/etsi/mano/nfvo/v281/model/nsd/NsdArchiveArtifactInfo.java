...
public class NsdArchiveArtifactInfo   {
  ...
  /**
   * Path in the NSD archive, which identifies the artifact and also allows to access a copy of the artifact. 
   * @return artifactPath
  **/
  ...
  **/
  ...
  /**
   * The metadata of the artifact that are available in the NSD Archive, such as Content type, size, creation date, etc. 
   * @return metadata
  **/
