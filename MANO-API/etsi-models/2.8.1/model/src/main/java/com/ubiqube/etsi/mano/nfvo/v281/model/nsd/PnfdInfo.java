...
import com.ubiqube.etsi.mano.nfvo.v281.model.nsd.PnfdArchiveArtifactInfo;
...
import com.ubiqube.etsi.mano.nfvo.v281.model.nsd.ProblemDetails;
...
public class PnfdInfo   {
  ...
  /**
   * Identifier of the on-boarded individual PNF descriptor resource. This identifier is allocated by the NFVO. 
   * @return id
  **/
  ...
  public PnfdInfo pnfdId(String pnfdId) {
    this.pnfdId = pnfdId;
    return this;
  }

  /**
   * This identifier, which is managed by the PNFD designer, identifies the PNFD in a globally unique way. It is copied from the PNFD content and shall be present after the PNFD content is on-boarded. 
   * @return pnfdId
  **/
  ...
  **/
  ...
  public PnfdInfo pnfdersion(String pnfdersion) {
  ...
  **/
  ...
  public PnfdInfo pnfdInvariantId(String pnfdInvariantId) {
  ...
  **/
  ...
  public PnfdInfo archiveSecurityOption(ArchiveSecurityOptionEnum archiveSecurityOption) {
  ...
  **/
  ...
  public PnfdInfo signingCertificate(String signingCertificate) {
  ...
  **/
  ...
  public PnfdInfo artifacts(List<PnfdArchiveArtifactInfo> artifacts) {
    this.artifacts = artifacts;
    return this;
  }

  public PnfdInfo addArtifactsItem(PnfdArchiveArtifactInfo artifactsItem) {
  ...
  **/
  ...
  public void setArtifacts(List<PnfdArchiveArtifactInfo> artifacts) {
    this.artifacts = artifacts;
  }
  ...
  **/
  ...
  public PnfdInfo links(PnfdInfoLinks links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public void setLinks(PnfdInfoLinks links) {
    this.links = links;
  }
