...
import com.ubiqube.etsi.mano.vnfm.v281.model.vnflcm.ExtVirtualLinkData;
...
public class InstantiateVnfRequest   {
  ...
  **/
  ...
  /**
   * Information about internal VLs that are managed by the NFVO. NOTE: The indication of externally-managed internal VLs is needed in case networks  have been pre-configured for use with certain VNFs, for instance to ensure that these  networks have certain properties such as security or acceleration features, or to address  particular network topologies. The present document assumes that externally-managed internal  VLs are managed by the NFVO and created towards the VIM. 
   * @return extManagedVirtualLinks
  **/
  @ApiModelProperty(value = "Information about internal VLs that are managed by the NFVO. NOTE: The indication of externally-managed internal VLs is needed in case networks  have been pre-configured for use with certain VNFs, for instance to ensure that these  networks have certain properties such as security or acceleration features, or to address  particular network topologies. The present document assumes that externally-managed internal  VLs are managed by the NFVO and created towards the VIM. ")
  ...
  **/
   ...
   * @return extensions
  **/
  @ApiModelProperty(value = "If present, this attribute provides modifications to the default values, as obtained  from the VNFD, of the \"extensions\" attribute in \"VnfInstance\", as defined in clause  5.5.2.2.  Provisions for handling extensions during the operation are defined in clause 5.4.4.3.1. ")
