...
import com.ubiqube.etsi.mano.vnfm.v281.model.grant.ProblemDetails2;
...
public interface Grants281Sol003Api {
	...
	@RequestMapping(value = "/grants/{grantId}", produces = { "application/json" }, consumes = { "application/json" }, method = RequestMethod.GET)
