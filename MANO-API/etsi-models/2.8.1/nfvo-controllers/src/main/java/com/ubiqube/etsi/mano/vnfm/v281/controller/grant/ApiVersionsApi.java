...
import com.ubiqube.etsi.mano.vnfm.v281.model.grant.ApiVersionInformation;
import com.ubiqube.etsi.mano.vnfm.v281.model.grant.ProblemDetails;
...
public interface ApiVersionsApi {
    ...
    @ApiOperation(value = "", nickname = "apiVersionsDelete", notes = "This method is not supported. When this method is requested on this resource, the API producer shall return a \"405 Method Not Allowed\" response ", tags={  })
    @ApiResponses(value = { 
    ...
    default ResponseEntity<Void> apiVersionsDelete(@ApiParam(value = "Version of the API requested to use when responding to this request. " ) @RequestHeader(value="Version", required=false) String version) {
    ...
    default ResponseEntity<ApiVersionInformation> apiVersionsGet(@ApiParam(value = "Version of the API requested to use when responding to this request. " ) @RequestHeader(value="Version", required=false) String version) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("{  \"apiVersions\" : [ {    \"isDeprecated\" : true,    \"retirementDate\" : { },    \"version\" : \"version\"  }, {    \"isDeprecated\" : true,    \"retirementDate\" : { },    \"version\" : \"version\"  } ],  \"uriPrefix\" : \"uriPrefix\"}", ApiVersionInformation.class), HttpStatus.NOT_IMPLEMENTED);
                } catch (IOException e) {
    ...
    @ApiOperation(value = "", nickname = "apiVersionsPatch", notes = "This method is not supported. When this method is requested on this resource, the API producer shall return a \"405 Method Not Allowed\" response ", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 405, message = "405 METHOD NOT ALLOWED If a particular HTTP method is not supported for a particular resource, the API producer shall respond with this response code. The \"ProblemDetails\" structure may be omitted. ", response = ProblemDetails.class) })
    @RequestMapping(value = "/api_versions",
        produces = { "application/json" }, 
    ...
    default ResponseEntity<Void> apiVersionsPatch(@ApiParam(value = "Version of the API requested to use when responding to this request. " ) @RequestHeader(value="Version", required=false) String version) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
        } else {
            log.warn("ObjectMapper or HttpServletRequest not configured in default ApiVersionsApi interface so no example is generated");
        }
    ...
    @ApiOperation(value = "", nickname = "apiVersionsPost", notes = "This method is not supported. When this method is requested on this resource, the API producer shall return a \"405 Method Not Allowed\" response ", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 405, message = "405 METHOD NOT ALLOWED If a particular HTTP method is not supported for a particular resource, the API producer shall respond with this response code. The \"ProblemDetails\" structure may be omitted. ", response = ProblemDetails.class) })
    @RequestMapping(value = "/api_versions",
        produces = { "application/json" }, 
    ...
    default ResponseEntity<Void> apiVersionsPost(@ApiParam(value = "Version of the API requested to use when responding to this request. " ) @RequestHeader(value="Version", required=false) String version) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
        } else {
            log.warn("ObjectMapper or HttpServletRequest not configured in default ApiVersionsApi interface so no example is generated");
        }
    ...
    @ApiOperation(value = "", nickname = "apiVersionsPut", notes = "This method is not supported. When this method is requested on this resource, the API producer shall return a \"405 Method Not Allowed\" response ", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 405, message = "405 METHOD NOT ALLOWED If a particular HTTP method is not supported for a particular resource, the API producer shall respond with this response code. The \"ProblemDetails\" structure may be omitted. ", response = ProblemDetails.class) })
    @RequestMapping(value = "/api_versions",
        produces = { "application/json" }, 
    ...
    default ResponseEntity<Void> apiVersionsPut(@ApiParam(value = "Version of the API requested to use when responding to this request. " ) @RequestHeader(value="Version", required=false) String version) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
        } else {
            log.warn("ObjectMapper or HttpServletRequest not configured in default ApiVersionsApi interface so no example is generated");
        }
