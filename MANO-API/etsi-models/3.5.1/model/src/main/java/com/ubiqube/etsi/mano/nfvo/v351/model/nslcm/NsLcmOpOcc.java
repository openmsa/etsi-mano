...
import com.ubiqube.etsi.mano.nfvo.v351.model.nslcm.CancelModeType;
import com.ubiqube.etsi.mano.nfvo.v351.model.nslcm.NsLcmOpOccLcmCoordinations;
import com.ubiqube.etsi.mano.nfvo.v351.model.nslcm.NsLcmOpOccLinks;
import com.ubiqube.etsi.mano.nfvo.v351.model.nslcm.NsLcmOpOccRejectedLcmCoordinations;
import com.ubiqube.etsi.mano.nfvo.v351.model.nslcm.NsLcmOpOccResourceChanges;
import com.ubiqube.etsi.mano.nfvo.v351.model.nslcm.NsLcmOpType;
import com.ubiqube.etsi.mano.nfvo.v351.model.nslcm.NsLcmOperationStateType;
...
public class NsLcmOpOcc   {
  ...
  public NsLcmOpOcc stateEnteredTime(OffsetDateTime stateEnteredTime) {
  ...
  public NsLcmOpOcc startTime(OffsetDateTime startTime) {
  ...
  public NsLcmOpOcc lcmCoordinations(List<NsLcmOpOccLcmCoordinations> lcmCoordinations) {
    this.lcmCoordinations = lcmCoordinations;
    return this;
  }

  public NsLcmOpOcc addLcmCoordinationsItem(NsLcmOpOccLcmCoordinations lcmCoordinationsItem) {
  ...
  /**
   * Information about LCM coordination actions (see clause 12) related to this LCM operation occurrence. 
  ...
  public void setLcmCoordinations(List<NsLcmOpOccLcmCoordinations> lcmCoordinations) {
    this.lcmCoordinations = lcmCoordinations;
  }

  public NsLcmOpOcc rejectedLcmCoordinations(List<NsLcmOpOccRejectedLcmCoordinations> rejectedLcmCoordinations) {
    this.rejectedLcmCoordinations = rejectedLcmCoordinations;
    return this;
  }

  public NsLcmOpOcc addRejectedLcmCoordinationsItem(NsLcmOpOccRejectedLcmCoordinations rejectedLcmCoordinationsItem) {
  ...
  /**
   * Information about LCM coordination actions (see clause 12) that were rejected by 503 error which means they can be tried again after a delay. See note 3. 
  ...
  public void setRejectedLcmCoordinations(List<NsLcmOpOccRejectedLcmCoordinations> rejectedLcmCoordinations) {
    this.rejectedLcmCoordinations = rejectedLcmCoordinations;
  }

  public NsLcmOpOcc warnings(List<String> warnings) {
    this.warnings = warnings;
    return this;
  }

  public NsLcmOpOcc addWarningsItem(String warningsItem) {
  ...
  /**
   * Warning messages that were generated while the operation was executing. If the operation has included VNF LCM operations or NS LCM coordination actions and these have resulted in warnings, such warnings should be added to this attribute. 
   * @return warnings
   **/
  ...
  public NsLcmOpOcc _links(NsLcmOpOccLinks _links) {
    this._links = _links;
    return this;
  }
  ...
  public void setLinks(NsLcmOpOccLinks _links) {
    this._links = _links;
  }
