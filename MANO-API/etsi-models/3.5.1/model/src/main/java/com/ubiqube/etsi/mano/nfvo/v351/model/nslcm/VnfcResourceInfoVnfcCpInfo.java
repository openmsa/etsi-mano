...
import com.ubiqube.etsi.mano.nfvo.v351.model.nslcm.CpProtocolInfo;
...
public class VnfcResourceInfoVnfcCpInfo   {
  ...
  /**
   * Network protocol information for this CP. May be omitted if the VNFC CP is exposed as an external CP. See note 3. 
  ...
  public VnfcResourceInfoVnfcCpInfo parentCpId(String parentCpId) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, cpdId, vnfExtCpId, cpProtocolInfo, parentCpId, vnfLinkPortId, metadata);
  }
