...
import com.ubiqube.etsi.mano.vnfm.v351.model.vnflcm.VnfcResourceInfoVnfcCpInfo;
...
/**
 * This type represents the information on virtualised compute and storage resources  used by a VNFC in a VNF instance. It shall comply with the provisions defined in  table 5.5.3.5-1. NOTE 1: ETSI GS NFV-SOL 001 specifies the structure and format of the VNFD based on          TOSCA specifications. NOTE 2: A VNFC CP is \&quot;connected to\&quot; an external CP if the VNFC CP is connected to an          internal VL that exposes an external CP. A VNFC CP is \&quot;exposed as\&quot; an external          CP if it is connected directly to an external VL. NOTE 3: The information can be omitted because it is already available as part of the          external CP information. 
 */
@Schema(description = "This type represents the information on virtualised compute and storage resources  used by a VNFC in a VNF instance. It shall comply with the provisions defined in  table 5.5.3.5-1. NOTE 1: ETSI GS NFV-SOL 001 specifies the structure and format of the VNFD based on          TOSCA specifications. NOTE 2: A VNFC CP is \"connected to\" an external CP if the VNFC CP is connected to an          internal VL that exposes an external CP. A VNFC CP is \"exposed as\" an external          CP if it is connected directly to an external VL. NOTE 3: The information can be omitted because it is already available as part of the          external CP information. ")
@Validated
...
public class VnfcResourceInfo   {
  ...
  public VnfcResourceInfo parentCpId(String parentCpId) {
  ...
  public void setParentCpId(String parentCpId) {
    this.parentCpId = parentCpId;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, vnfcResourceInfo.id) &&
        ...
        Objects.equals(this.parentCpId, vnfcResourceInfo.parentCpId) &&
        Objects.equals(this.metadata, vnfcResourceInfo.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, vduId, vnfdId, computeResource, zoneId, storageResourceIds, reservationId, vnfcCpInfo, parentCpId, metadata);
  }
