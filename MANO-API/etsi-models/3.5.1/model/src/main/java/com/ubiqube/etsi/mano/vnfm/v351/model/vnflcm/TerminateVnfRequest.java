...
/**
 * This type represents request parameters for the \&quot;Terminate VNF\&quot; operation.  It shall comply with the provisions defined in table 5.5.2.8-1. NOTE: If the VNF is still in service, requesting forceful termination can        adversely impact network service. 
 */
@Schema(description = "This type represents request parameters for the \"Terminate VNF\" operation.  It shall comply with the provisions defined in table 5.5.2.8-1. NOTE: If the VNF is still in service, requesting forceful termination can        adversely impact network service. ")
@Validated
