...
import com.ubiqube.etsi.mano.vnfm.v351.model.grant.ExtManagedVirtualLinkData;
import com.ubiqube.etsi.mano.vnfm.v351.model.grant.ExtVirtualLinkData;
import com.ubiqube.etsi.mano.vnfm.v351.model.grant.GrantInfo;
import com.ubiqube.etsi.mano.vnfm.v351.model.grant.GrantLinks;
import com.ubiqube.etsi.mano.vnfm.v351.model.grant.GrantVimAssets;
...
import com.ubiqube.etsi.mano.vnfm.v351.model.grant.ZoneGroupInfo;
import com.ubiqube.etsi.mano.vnfm.v351.model.grant.ZoneInfo;
...
public class Grant   {
  ...
  /**
   * List of resources that are approved to be added, with one entry per resource. Shall be set when resources are approved to be added and  shall contain the same set of resources requested to be added in the  related GrantRequest. 
   * @return addResources
   **/
  ...
  /**
   * List of resources that are approved to be removed, with one entry per resource. Shall be set when resources are approved to be removed and shall contain the same set of resources requested to be removed  in the related GrantRequest. 
  ...
  /**
   * List of resources that are approved to be modified, with one entry per resource. Shall be set when resources are approved to be updated and shall contain the same set of resources requested to be updated  in the related GrantRequest. 
  ...
  /**
   * Information about external VLs to connect the VNF to. See notes 5 and 7. If this attribute  is present according to note 5 or note 7, it need not contain those entries that are unchanged  compared to the entries that were passed in the LCM operation which is related to this granting exchange. 
