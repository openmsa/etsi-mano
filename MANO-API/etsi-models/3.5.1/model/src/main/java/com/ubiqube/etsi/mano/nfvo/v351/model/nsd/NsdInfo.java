...
import com.ubiqube.etsi.mano.nfvo.v351.model.nsd.NsdArchiveArtifactInfo;
...
public class NsdInfo  implements AnyOfNsdInfo {
  ...
  /**
   * Signals the security option used by the NSD archive as defined in clause 5.1 of ETSI GS NFV SOL 007. It shall be present after the VNF package content has been on-boarded and absent otherwise. Valid values: - OPTION_1 - OPTION_2 
   */
  ...
  /**
   * Identifies the VNF package for the VNFD referenced by the on-boarded NS descriptor resource. See note 1. 
   * @return vnfPkgIds
   **/
  ...
  /**
   * Identifies the NsdInfo element for the nested NSD referenced by the on-boarded NS descriptor resource. See note 1. 
