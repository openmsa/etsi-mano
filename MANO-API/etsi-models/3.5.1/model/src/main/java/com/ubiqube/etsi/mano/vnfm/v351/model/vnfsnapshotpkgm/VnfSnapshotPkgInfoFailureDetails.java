...
public class VnfSnapshotPkgInfoFailureDetails   {
  ...
  private ProblemDetails2 details = null;
  ...
  public VnfSnapshotPkgInfoFailureDetails details(ProblemDetails2 details) {
  ...
  @Schema(required = true, description = "")
    ...
    @Valid
    public ProblemDetails2 getDetails() {
    return details;
  }

  public void setDetails(ProblemDetails2 details) {
    this.details = details;
  }
