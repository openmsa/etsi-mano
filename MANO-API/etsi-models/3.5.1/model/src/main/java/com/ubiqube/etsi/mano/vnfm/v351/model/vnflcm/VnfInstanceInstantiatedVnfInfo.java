...
import com.ubiqube.etsi.mano.vnfm.v351.model.vnflcm.MonitoringParameter;
import com.ubiqube.etsi.mano.vnfm.v351.model.vnflcm.ScaleInfo;
import com.ubiqube.etsi.mano.vnfm.v351.model.vnflcm.VipCpInfo;
import com.ubiqube.etsi.mano.vnfm.v351.model.vnflcm.VirtualStorageResourceInfo;
...
import com.ubiqube.etsi.mano.vnfm.v351.model.vnflcm.VnfVirtualLinkResourceInfo;
...
public class VnfInstanceInstantiatedVnfInfo   {
   ...
   * @return extCpInfo
   **/
  @Schema(description = "Information about the external CPs exposed by the VNF instance. When trunking is enabled, the list of entries includes both, external CPs corresponding to parent ports of a trunk, and external CPs associated to sub-ports of a trunk. ")
      @Valid
  ...
  @Schema(description = "VIP CPs that are part of the VNF instance. Shall be present when that particular VIP CP of the VNFC instance is associated to an external CP of the VNF instance. May be present otherwise. ")
      @Valid
  @Size(min=1)   public List<VipCpInfo> getVipCpInfo() {
    return vipCpInfo;
  }
   ...
   **/
  @Schema(description = "Information about the externally-managed internal VLs of the VNF instance. See note 5 and note 6. ")
      @Valid
