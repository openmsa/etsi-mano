...
import com.ubiqube.etsi.mano.vnfm.v331.model.vnflcm.VnfcResourceInfoVnfcCpInfo;
...
public class VnfcResourceInfo   {
   ...
   * @return vnfcCpInfo
   **/
  @Schema(description = "All the CPs of the VNFC instance. Shall be present when that particular CP of the VNFC instance is exposed as an external CP of the VNF instance or is connected to an external CP of the VNF instance. A VNFC CP is \"connected to\" an external CP if the VNFC CP is connected to an internal VL that exposes an external CP. A VNFC CP is \"exposed as\" an external CP if it is connected directly to an external VL. May be present otherwise. ")
      @Valid
