...
import com.ubiqube.etsi.mano.vnfm.v331.model.vnfsnapshotpkgm.SnapshotPkgArtifactInfo;
import com.ubiqube.etsi.mano.vnfm.v331.model.vnfsnapshotpkgm.VnfSnapshotPkgInfoFailureDetails;
import com.ubiqube.etsi.mano.vnfm.v331.model.vnfsnapshotpkgm.VnfSnapshotPkgInfoLinks;
import com.ubiqube.etsi.mano.vnfm.v331.model.vnfsnapshotpkgm.VnfSnapshotRecord;
import com.ubiqube.etsi.mano.vnfm.v331.model.vnfsnapshotpkgm.VnfcSnapshotImageInfo;
import com.ubiqube.etsi.mano.vnfm.v331.model.vnfsnapshotpkgm.VnfdInfo;
 ...
 */
@Schema(description = "This type represents the information of a VNF snapshot package. ")
@Validated
...
public class VnfSnapshotPkgInfo   {
  ...
  /**
   * Information about VNF snapshot artifacts that are VNFC snapshot images. Every local and  external snapshot image shall be included. No other artifacts shall be included. NOTE: The attribute shall not be present before the VNF snapshot package content  has been uploaded or built. Otherwise, this attribute shall be present unless it  has been requested to be excluded per attribute selector. 
   * @return vnfcSnapshotImages
   **/
  @Schema(description = "Information about VNF snapshot artifacts that are VNFC snapshot images. Every local and  external snapshot image shall be included. No other artifacts shall be included. NOTE: The attribute shall not be present before the VNF snapshot package content  has been uploaded or built. Otherwise, this attribute shall be present unless it  has been requested to be excluded per attribute selector. ")
      @Valid
  ...
  /**
   * Information about VNF snapshot artifacts that are not VNFC snapshot images. NOTE: The attribute shall not be present before the VNF snapshot package content  has been uploaded or built. Otherwise, this attribute shall be present unless it  has been requested to be excluded per attribute selector. 
