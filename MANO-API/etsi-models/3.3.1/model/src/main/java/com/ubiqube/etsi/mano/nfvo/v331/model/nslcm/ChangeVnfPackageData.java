...
public class ChangeVnfPackageData   {
  ...
  public ChangeVnfPackageData vnfInstanceId(String vnfInstanceId) {
  ...
  public ChangeVnfPackageData vnfdId(String vnfdId) {
    this.vnfdId = vnfdId;
    return this;
  }
  ...
  public ChangeVnfPackageData extVirtualLinks(List<ExtVirtualLinkData> extVirtualLinks) {
    this.extVirtualLinks = extVirtualLinks;
    return this;
  }

  public ChangeVnfPackageData addExtVirtualLinksItem(ExtVirtualLinkData extVirtualLinksItem) {
  ...
  public ChangeVnfPackageData extManagedVirtualLinks(List<ExtManagedVirtualLinkData> extManagedVirtualLinks) {
    this.extManagedVirtualLinks = extManagedVirtualLinks;
    return this;
  }

  public ChangeVnfPackageData addExtManagedVirtualLinksItem(ExtManagedVirtualLinkData extManagedVirtualLinksItem) {
  ...
  public ChangeVnfPackageData additionalParams(Map<String, String> additionalParams) {
  ...
  public ChangeVnfPackageData extensions(Map<String, String> extensions) {
  ...
  public ChangeVnfPackageData vnfConfigurableProperties(Map<String, String> vnfConfigurableProperties) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ChangeVnfPackageData changeVnfPackageData = (ChangeVnfPackageData) o;
