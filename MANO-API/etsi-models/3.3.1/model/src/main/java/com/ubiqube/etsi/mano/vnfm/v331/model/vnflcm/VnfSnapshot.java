...
import com.ubiqube.etsi.mano.vnfm.v331.model.vnflcm.VnfSnapshotLinks;
import com.ubiqube.etsi.mano.vnfm.v331.model.vnflcm.VnfStateSnapshotInfo;
import com.ubiqube.etsi.mano.vnfm.v331.model.vnflcm.VnfcSnapshotInfo;
 ...
 */
@Schema(description = "This type represents a VNF snapshot. It shall comply with the provisions defined in table 5.5.2.23-1. ")
@Validated
...
public class VnfSnapshot   {
  ...
  public VnfSnapshot vnfStateSnapshotInfo(VnfStateSnapshotInfo vnfStateSnapshotInfo) {
  ...
  public void setVnfStateSnapshotInfo(VnfStateSnapshotInfo vnfStateSnapshotInfo) {
    this.vnfStateSnapshotInfo = vnfStateSnapshotInfo;
  }
  ...
  public VnfSnapshot _links(VnfSnapshotLinks _links) {
    this._links = _links;
    return this;
  }
  ...
  public void setLinks(VnfSnapshotLinks _links) {
    this._links = _links;
  }
