...
import com.ubiqube.etsi.mano.vnfm.v331.model.vnflcm.MonitoringParameter;
import com.ubiqube.etsi.mano.vnfm.v331.model.vnflcm.ScaleInfo;
import com.ubiqube.etsi.mano.vnfm.v331.model.vnflcm.VirtualStorageResourceInfo;
...
import com.ubiqube.etsi.mano.vnfm.v331.model.vnflcm.VnfVirtualLinkResourceInfo;
...
public class VnfInstanceInstantiatedVnfInfo   {
  ...
  /**
   * Information about the externally-managed internal VLs of the VNF instance. NOTE: It is possible to have several ExtManagedVirtualLinkInfo for the same VNF internal VL in case of a multi-site VNF spanning several VIMs. The set of ExtManagedVirtualLinkInfo corresponding to the same VNF internal VL shall indicate so by referencing to the same VnfVirtualLinkDesc and externally-managed multi-site VL instance (refer to clause 5.5.3.3). 
   * @return extManagedVirtualLinkInfo
   **/
  @Schema(description = "Information about the externally-managed internal VLs of the VNF instance. NOTE: It is possible to have several ExtManagedVirtualLinkInfo for the same VNF internal VL in case of a multi-site VNF spanning several VIMs. The set of ExtManagedVirtualLinkInfo corresponding to the same VNF internal VL shall indicate so by referencing to the same VnfVirtualLinkDesc and externally-managed multi-site VL instance (refer to clause 5.5.3.3). ")
      @Valid
