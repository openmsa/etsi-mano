...
import com.ubiqube.etsi.mano.vnfm.v331.model.vnflcm.VnfLinkPortInfo;
...
public class ExtManagedVirtualLinkInfo   {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, vnfVirtualLinkDescId, vnfdId, networkResource, vnfLinkPorts, extManagedMultisiteVirtualLinkId);
  }
