...
import com.ubiqube.etsi.mano.em.v331.model.vnfind.ProblemDetails;
...
public interface IndicatorsApi {
    ...
    @Operation(summary = "Query multiple indicators related to a VNF instance.", description = "Get a list of indicators related to a specific VNF instance. Support of attribute based filtering via query parameters. ", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "504", description = "504 GATEWAY TIMEOUT If the API producer encounters a timeout while waiting for a response from an upstream server (i.e. a server that the API producer communicates with when fulfilling a request), it should respond with this response code. ", content = @Content(schema = @Schema(implementation = ProblemDetails.class))) })
    @RequestMapping(value = "/indicators/{vnfInstanceId}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<List<VnfIndicator>> indicatorsVnfInstanceIdGet(@Parameter(in = ParameterIn.PATH, description = "Service Unavailable. Identifier of the VNF instance to which the VNF indicators applies. NOTE: This identifier can be retrieved from the resource referenced by the \"Location\" HTTP header in the response to a POST request creating a new VNF instance resource. It can also be retrieved from the \"id\" attribute in the payload body of that response. ", required=true, schema=@Schema()) @PathVariable("vnfInstanceId") String vnfInstanceId, @Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. " ,required=true,schema=@Schema()) @RequestHeader(value="Version", required=true) String version, @Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. " ,schema=@Schema()) @RequestHeader(value="Authorization", required=false) String authorization, @Parameter(in = ParameterIn.QUERY, description = "Attribute-based filtering expression according to clause 5.2 of ETSI GS NFV-SOL 013. The NFV-MANO functional entity shall support receiving this parameter as part of the URI query string. The API consumer may supply this parameter. All attribute names that appear in the FmSubscription and in data types referenced from it shall be supported by the NFV-MANO functional entity in the filter expression. " ,schema=@Schema()) @Valid @RequestParam(value = "filter", required = false) String filter, @Parameter(in = ParameterIn.QUERY, description = "Marker to obtain the next page of a paged response. Shall be supported by the NFV-MANO functional entity if the entity supports alternative 2 (paging) according to clause 5.4.2.1 of ETSI GS NFV-SOL 013 for this resource. " ,schema=@Schema()) @Valid @RequestParam(value = "nextpage_opaque_marker", required = false) String nextpageOpaqueMarker) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("[ {\n  \"vnfInstanceId\" : \"vnfInstanceId\",\n  \"_links\" : {\n    \"self\" : {\n      \"href\" : \"href\"\n    }\n  },\n  \"name\" : \"name\",\n  \"id\" : \"id\",\n  \"value\" : { }\n}, {\n  \"vnfInstanceId\" : \"vnfInstanceId\",\n  \"_links\" : {\n    \"self\" : {\n      \"href\" : \"href\"\n    }\n  },\n  \"name\" : \"name\",\n  \"id\" : \"id\",\n  \"value\" : { }\n} ]", List.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    @Operation(summary = "Read an inidividual VNF indicator related to a VNF instance.", description = "Read an individual VNF indicator related to a specific VNF instance. NOTE: This identifier can be retrieved from the resource referenced by the \"Location\" HTTP header in the response to a POST request creating a new VNF instance resource. It can also be retrieved from the \"id\" attribute in the payload body of that response. ", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "504", description = "504 GATEWAY TIMEOUT If the API producer encounters a timeout while waiting for a response from an upstream server (i.e. a server that the API producer communicates with when fulfilling a request), it should respond with this response code. ", content = @Content(schema = @Schema(implementation = ProblemDetails.class))) })
    @RequestMapping(value = "/indicators/{vnfInstanceId}/{indicatorId}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<VnfIndicator> indicatorsVnfInstanceIdIndicatorIdGet(@Parameter(in = ParameterIn.PATH, description = "Service Unavailable. Identifier of the VNF instance to which the VNF indicators applies. NOTE: This identifier can be retrieved from the resource referenced by the \"Location\" HTTP header in the response to a POST request creating a new VNF instance resource. It can also be retrieved from the \"id\" attribute in the payload body of that response. ", required=true, schema=@Schema()) @PathVariable("vnfInstanceId") String vnfInstanceId, @Parameter(in = ParameterIn.PATH, description = "Identifier of the VNF indicator. ", required=true, schema=@Schema()) @PathVariable("indicatorId") String indicatorId, @Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. " ,required=true,schema=@Schema()) @RequestHeader(value="Version", required=true) String version, @Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. " ,schema=@Schema()) @RequestHeader(value="Authorization", required=false) String authorization) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
