...
public interface Thresholds331Sol002Api {
	...
	Logger log = LoggerFactory.getLogger(Thresholds331Sol002Api.class);
	...
	@Operation(summary = "", description = "The POST method can be used by the client to create a threshold. As the result of successfully executing this method, a new  \"Individual threshold\" resource as defined in clause 6.4.6 shall  have been created. ", tags = {})
	@ApiResponses(value = {
	...
	@Operation(summary = "", description = "This method allows to delete a threshold. As the result of successfully executing this method, the \"Individual threshold\" resource shall not exist any longer. ", tags = {})
	@ApiResponses(value = {
	...
	default ResponseEntity<ThresholdModifications> thresholdsThresholdIdPatch(@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.PATH, description = "Identifier of the threshold. This identifier can be retrieved from the resource referenced by the \"Location\" HTTP header in the response to a POST request creating a new threshold resource. It can also be retrieved from the \"id\" attribute in the payload body of that response. ", required = true, schema = @Schema()) @PathVariable("thresholdId") final String thresholdId, @Parameter(in = ParameterIn.DEFAULT, description = "Parameters for the threshold modification.", required = true, schema = @Schema()) @Valid @RequestBody final ThresholdModifications body, @Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
