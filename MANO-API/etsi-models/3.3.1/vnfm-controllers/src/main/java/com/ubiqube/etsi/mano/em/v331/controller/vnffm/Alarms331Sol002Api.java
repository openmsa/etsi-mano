...
public interface Alarms331Sol002Api {
	...
	Logger log = LoggerFactory.getLogger(Alarms331Sol002Api.class);
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "204 No Content Shall be returned when the VNFM has received the proposed \"escalated  perceived severity\" value successfully. The response body shall be empty. "),
