...
public interface VnfSnapshotPackages331Sol003Api {
	...
	Logger log = LoggerFactory.getLogger(VnfSnapshotPackages331Sol003Api.class);
	...
	default ResponseEntity<List<VnfSnapshotPkgInfo>> vnfSnapshotPackagesGet(@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept, @Parameter(in = ParameterIn.HEADER, description = "The MIME type of the body of the request. Reference: IETF RFC 7231 ", required = true, schema = @Schema()) @RequestHeader(value = "Content-Type", required = true) final String contentType, @Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization,
		...
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
					return new ResponseEntity<>(getObjectMapper().get().readValue(
							"[ {\n  \"vnfcSnapshotInfoIds\" : [ \"vnfcSnapshotInfoIds\", \"vnfcSnapshotInfoIds\" ],\n  \"isFullSnapshot\" : true,\n  \"_links\" : {\n    \"self\" : { }\n  },\n  \"additionalArtifacts\" : [ { }, { } ],\n  \"vnfdInfo\" : { },\n  \"createdAt\" : \"2000-01-23T04:56:07.000+00:00\",\n  \"failureDetails\" : {\n    \"errorType\" : \"BUILD_ERROR\",\n    \"details\" : {\n      \"instance\" : \"instance\",\n      \"detail\" : \"detail\",\n      \"type\" : \"type\",\n      \"title\" : \"title\",\n      \"status\" : 6\n    }\n  },\n  \"vnfcSnapshotImages\" : [ {\n    \"minDisk\" : 0,\n    \"imageUri\" : \"imageUri\",\n    \"vnfcInstanceId\" : \"vnfcInstanceId\",\n    \"containerFormat\" : \"AKI\",\n    \"diskFormat\" : \"AKI\",\n    \"userMetadata\" : { }\n  }, {\n    \"minDisk\" : 0,\n    \"imageUri\" : \"imageUri\",\n    \"vnfcInstanceId\" : \"vnfcInstanceId\",\n    \"containerFormat\" : \"AKI\",\n    \"diskFormat\" : \"AKI\",\n    \"userMetadata\" : { }\n  } ],\n  \"name\" : \"name\",\n  \"checksum\" : \"checksum\",\n  \"id\" : \"id\",\n  \"state\" : \"CREATED\",\n  \"vnfsr\" : { }\n}, {\n  \"vnfcSnapshotInfoIds\" : [ \"vnfcSnapshotInfoIds\", \"vnfcSnapshotInfoIds\" ],\n  \"isFullSnapshot\" : true,\n  \"_links\" : {\n    \"self\" : { }\n  },\n  \"additionalArtifacts\" : [ { }, { } ],\n  \"vnfdInfo\" : { },\n  \"createdAt\" : \"2000-01-23T04:56:07.000+00:00\",\n  \"failureDetails\" : {\n    \"errorType\" : \"BUILD_ERROR\",\n    \"details\" : {\n      \"instance\" : \"instance\",\n      \"detail\" : \"detail\",\n      \"type\" : \"type\",\n      \"title\" : \"title\",\n      \"status\" : 6\n    }\n  },\n  \"vnfcSnapshotImages\" : [ {\n    \"minDisk\" : 0,\n    \"imageUri\" : \"imageUri\",\n    \"vnfcInstanceId\" : \"vnfcInstanceId\",\n    \"containerFormat\" : \"AKI\",\n    \"diskFormat\" : \"AKI\",\n    \"userMetadata\" : { }\n  }, {\n    \"minDisk\" : 0,\n    \"imageUri\" : \"imageUri\",\n    \"vnfcInstanceId\" : \"vnfcInstanceId\",\n    \"containerFormat\" : \"AKI\",\n    \"diskFormat\" : \"AKI\",\n    \"userMetadata\" : { }\n  } ],\n  \"name\" : \"name\",\n  \"checksum\" : \"checksum\",\n  \"id\" : \"id\",\n  \"state\" : \"CREATED\",\n  \"vnfsr\" : { }\n} ]",
			...
			log.warn("ObjectMapper or HttpServletRequest not configured in default VnfSnapshotPackagesApi interface so no example is generated");
		}
	...
	default ResponseEntity<VnfSnapshotPkgInfo> vnfSnapshotPackagesVnfSnapshotPkgIdGet(@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.PATH, description = "Identifier of the VNF snapshot package. The identifier is allocated by the NFVO. This identifier can be retrieved from the \"id\" attribute of the applicable \"VnfSnapshotPkgInfo\" in the body of the response to requesting the creation of a new \"Individual VNF snapshot package\" resource or in a response to  a GET request querying the \"Individual VNF snapshot package\" or the \"VNF snapshot packages\" resource. ", required = true, schema = @Schema()) @PathVariable("vnfSnapshotPkgId") final String vnfSnapshotPkgId, @Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept,
	...
	@Operation(summary = "", description = "The GET method fetches the content of a VNF snapshot package. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK  Shall be returned when the whole content of the VNF snapshot package file has been read successfully.  The response body shall include a copy of the VNF snapshot package file.   The \"Content-Type\" HTTP header shall be set according to the type of the file, i.e. to \"application/zip\"  for a VNF snapshot package. The VNF snapshot package format is defined in ETSI GS NFV-SOL 010. ", content = @Content(schema = @Schema(implementation = Resource.class))),

			@ApiResponse(responseCode = "206", description = "206 PARTIAL CONTENT  If the NFVO supports range requests, this response shall be returned when a single consecutive byte range  from the content of the VNF snapshot package file has been read successfully according to the request.   The response body shall contain the requested part of the VNF snapshot package file. The \"Content-Range\"  HTTP header shall be provided according to IETF RFC 7233. The \"Content-Type\" HTTP header shall be set as  defined above for the \"200 OK\" response. ", content = @Content(schema = @Schema(implementation = Resource.class))),
	...
	default ResponseEntity<Resource> vnfSnapshotPackagesVnfSnapshotPkgIdPackageContentGet(@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.PATH, description = "Identifier of the VNF snapshot package. The identifier is allocated by the NFVO. This identifier can be retrieved from the \"id\" attribute of the applicable \"VnfSnapshotPkgInfo\" in the body of the response to requesting the creation of a new \"Individual VNF snapshot package\" resource or in a response to  a GET request querying the \"Individual VNF snapshot package\" or the \"VNF snapshot packages\" resource. ", required = true, schema = @Schema()) @PathVariable("vnfSnapshotPkgId") final String vnfSnapshotPkgId, @Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept,
			@Parameter(in = ParameterIn.HEADER, description = "The MIME type of the body of the request. Reference: IETF RFC 7231 ", required = true, schema = @Schema()) @RequestHeader(value = "Content-Type", required = true) final String contentType, @Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
