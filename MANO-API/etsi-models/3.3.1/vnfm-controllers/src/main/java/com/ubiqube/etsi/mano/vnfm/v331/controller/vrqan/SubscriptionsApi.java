...
import com.ubiqube.etsi.mano.vnfm.v331.model.vrqan.ProblemDetails;
...
public interface SubscriptionsApi {
	...
	@Operation(summary = "", description = "Query Subscription Information. The GET method reads an individual subscription. This method shall follow the provisions specified in the tables 11.4.3.3.2-1 and 11.4.3.3.2-2 for URI query parameters, request and response data structures, and response codes. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK  Shall be returned when information about an individual subscription has been read successfully. The response body shall contain a representation of the \"Individual subscription\" resource. ", content = @Content(schema = @Schema(implementation = VrQuotaAvailSubscription.class))),
