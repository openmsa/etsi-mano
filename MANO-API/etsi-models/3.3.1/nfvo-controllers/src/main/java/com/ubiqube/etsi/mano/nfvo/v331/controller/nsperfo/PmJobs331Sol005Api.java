...
public interface PmJobs331Sol005Api {
	...
	@Operation(summary = "Query PM jobs.", description = "The API consumer can use this method to retrieve information about PM jobs. ", tags = {})
	@ApiResponses(value = {
	...
	@Operation(summary = "Read a single PM job.", description = "The API consumer can use this method for reading an individual PM job. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK  Shall be returned when information about an individual  PM job has been queried successfully. The response body shall contain a representation of the \"Individual PM job resource\", as defined in clause 7.5.2.7. ", content = @Content(schema = @Schema(implementation = PmJob.class))),
	...
	@Operation(summary = "Modify a PM job.", description = "This method allows to modify an \"individual PM job\" resource. This method shall follow the provisions specified in the Tables 7.4.3.3.4-1 and 7.4.3.3.4-2 for URI query parameters, request and response data structures, and response codes. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK  Shall be returned when the request has been processed successfully. The response body shall contain a data structure of type \"PmJobModifications\". ", content = @Content(schema = @Schema(implementation = PmJobModifications.class))),
	...
	default ResponseEntity<PmJobModifications> pmJobsPmJobIdPatch(@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.HEADER, description = "The MIME type of the body of the request. Reference: IETF RFC 7231 ", required = true, schema = @Schema(allowableValues = { "application/merge-patch+json" })) @RequestHeader(value = "Content-Type", required = true) final String contentType, @Parameter(in = ParameterIn.PATH, description = "Identifier of the PM job. This identifier can be retrieved from the resource referenced by the \"Location\" HTTP header in the response to a POST request creating a new PM job resource. It can also be retrieved from the \"id\" attribute in the payload body of that response.           ", required = true, schema = @Schema()) @PathVariable("pmJobId") final String pmJobId, @Parameter(in = ParameterIn.DEFAULT, description = "", required = true, schema = @Schema()) @Valid @RequestBody final PmJobModifications body,
		...
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
					return new ResponseEntity<>(getObjectMapper().get().readValue("{\n  \"callbackUri\" : \"http://example.com/aeiou\",\n  \"authentication\" : {\n    \"paramsOauth2ClientCredentials\" : {\n      \"clientId\" : \"clientId\",\n      \"clientPassword\" : \"clientPassword\"\n    },\n    \"paramsBasic\" : {\n      \"password\" : \"password\",\n      \"userName\" : \"userName\"\n    },\n    \"authType\" : [ \"BASIC\", \"BASIC\" ]\n  }\n}", PmJobModifications.class), HttpStatus.NOT_IMPLEMENTED);
				} catch (final IOException e) {
					log.error("Couldn't serialize response for content type application/json", e);
					return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
				}
	...
	@Operation(summary = "Read an individual performance report.", description = "The API consumer can use this method for reading an individual performance report. ", tags = {})
	@ApiResponses(value = {
	...
	default ResponseEntity<PmJob> pmJobsPost(@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept, @Parameter(in = ParameterIn.HEADER, description = "The MIME type of the body of the request. Reference: IETF RFC 7231 ", required = true, schema = @Schema()) @RequestHeader(value = "Content-Type", required = true) final String contentType,
			@Parameter(in = ParameterIn.DEFAULT, description = "The VNF creation parameters.", required = true, schema = @Schema()) @Valid @RequestBody final CreatePmJobRequest body, @Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
					return new ResponseEntity<>(getObjectMapper().get().readValue("{\n  \"reports\" : {\n    \"fileSize\" : 1,\n    \"_links\" : {\n      \"objects\" : [ null, null ],\n      \"self\" : {\n        \"href\" : \"http://example.com/aeiou\"\n      }\n    }\n  },\n  \"subObjectInstanceIds\" : [ \"subObjectInstanceIds\", \"subObjectInstanceIds\" ],\n  \"objectInstanceIds\" : [ null, null ],\n  \"criteria\" : {\n    \"collectionPeriod\" : 0,\n    \"reportingPeriod\" : 0,\n    \"reportingBoundary\" : \"\",\n    \"performanceMetricGroup\" : [ null, null ],\n    \"performanceMetric\" : [ null, null ]\n  },\n  \"callbackUri\" : \"http://example.com/aeiou\",\n  \"id\" : \"id\",\n  \"objectType\" : \"objectType\"\n}", PmJob.class), HttpStatus.NOT_IMPLEMENTED);
