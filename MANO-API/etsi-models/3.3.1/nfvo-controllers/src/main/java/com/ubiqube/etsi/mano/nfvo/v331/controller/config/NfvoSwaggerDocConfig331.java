 ...
 */
package com.ubiqube.etsi.mano.nfvo.v331.controller.config;
...
public class NfvoSwaggerDocConfig331 {
	...
	@Bean
	public Docket customImplementationNfvo331() {
		return new Docket(DocumentationType.SWAGGER_2)
				.pathProvider(new CustomPathProvider())
				.groupName("nfvo-etsi-mano-3.3.1")
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.ubiqube.etsi.mano.nfvo.v331"))
				.build()
