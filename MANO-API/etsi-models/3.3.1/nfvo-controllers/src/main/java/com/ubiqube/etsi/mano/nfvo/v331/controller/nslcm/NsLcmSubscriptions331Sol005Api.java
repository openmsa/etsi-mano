...
public interface NsLcmSubscriptions331Sol005Api {

	Logger log = LoggerFactory.getLogger(NsLcmSubscriptions331Sol005Api.class);
	...
	@Operation(summary = "Query multiple subscriptions.", description = "Query Subscription Information. The GET method queries the list of active subscriptions of the functional block that invokes the method. It can be used e.g. for resynchronization after error situations. ", tags = {})
	@ApiResponses(value = {
	...
	@Operation(summary = "Read an individual subscription resource.", description = "The GET method retrieves information about a subscription by reading an individual subscription resource. This method shall support the URI query parameters, request and response data structures, and response codes, as specified in the Tables 6.4.17.3.2-1 and 6.4.17.3.2-2 ", tags = {})
	@ApiResponses(value = {
