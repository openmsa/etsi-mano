...
public interface Thresholds331Sol005Api {

	Logger log = LoggerFactory.getLogger(Thresholds331Sol005Api.class);
	...
	@Operation(summary = "Query thresholds.", description = "The API consumer can use this method to query information about thresholds. ", tags = {})
	@ApiResponses(value = {
	...
	default ResponseEntity<Threshold> thresholdsPost(@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept, @Parameter(in = ParameterIn.HEADER, description = "The MIME type of the body of the request. Reference: IETF RFC 7231 ", required = true, schema = @Schema()) @RequestHeader(value = "Content-Type", required = true) final String contentType,
			@Parameter(in = ParameterIn.DEFAULT, description = "Request parameters to create a new \"Individual threshold\" resource.", required = true, schema = @Schema()) @Valid @RequestBody final CreateThresholdRequest body, @Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
	...
	@Operation(summary = "Delete a Threshold.", description = "This method allows to delete a threshold.  As the result of successfully executing this method, the  \"Individual threshold\" resource shall not exist any longer. ", tags = {})
	@ApiResponses(value = {
	...
	@Operation(summary = "Query a single threshold.", description = "The API consumer can use this method for reading an individual threshold. This method shall follow the provisions specified in the  Tables 7.4.6.3.2-1 and 7.4.6.3.2-2 for URI query parameters, request and response data structures, and response codes. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK  Shall be returned when information about an individual threshold  has been queried successfully. The response body shall contain a representation of the threshold, as defined in clause 7.5.2.9.             ", content = @Content(schema = @Schema(implementation = Threshold.class))),
	...
	@Operation(summary = "Modify a Threshold", description = "This method allows to modify an \"Individual threshold\" resource. This method shall follow the provisions specified in the Tables 7.4.6.3.4-1 and 7.4.6.3.4-2 for URI query parameters, request and response data structures, and response codes. ", tags = {})
	@ApiResponses(value = {
	...
	default ResponseEntity<ThresholdModifications> thresholdsThresholdIdPatch(@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.HEADER, description = "The MIME type of the body of the request. Reference: IETF RFC 7231 ", required = true, schema = @Schema(allowableValues = { "application/merge-patch+json" })) @RequestHeader(value = "Content-Type", required = true) final String contentType, @Parameter(in = ParameterIn.PATH, description = "Identifier of the threshold. This identifier can be retrieved from the resource referenced by the \"Location\" HTTP header in the response to a POST request creating a new threshold resource. It can also be retrieved from the \"id\" attribute in the payload body of that response. ", required = true, schema = @Schema()) @PathVariable("thresholdId") final String thresholdId, @Parameter(in = ParameterIn.DEFAULT, description = "", required = true, schema = @Schema()) @Valid @RequestBody final ThresholdModifications body,
