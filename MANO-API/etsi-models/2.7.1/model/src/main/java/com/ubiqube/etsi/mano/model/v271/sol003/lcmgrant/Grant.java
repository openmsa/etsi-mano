...
import com.ubiqube.etsi.mano.model.v271.sol003.lcmgrant.ExtManagedVirtualLinkData;
import com.ubiqube.etsi.mano.model.v271.sol003.lcmgrant.ExtVirtualLinkData;
import com.ubiqube.etsi.mano.model.v271.sol003.lcmgrant.GrantInfo;
import com.ubiqube.etsi.mano.model.v271.sol003.lcmgrant.GrantLinks;
import com.ubiqube.etsi.mano.model.v271.sol003.lcmgrant.GrantVimAssets;
import com.ubiqube.etsi.mano.model.v271.sol003.lcmgrant.KeyValuePairs;
import com.ubiqube.etsi.mano.model.v271.sol003.lcmgrant.VimConnectionInfo;
import com.ubiqube.etsi.mano.model.v271.sol003.lcmgrant.ZoneGroupInfo;
import com.ubiqube.etsi.mano.model.v271.sol003.lcmgrant.ZoneInfo;
...
public class Grant   {
  ...
  **/
  ...
  /**
   * Information that identifies a reservation applicable to the compute resource requirements of the corresponding grant request. At least one of (computeReservationId, networkReservationId, storageReservationId) shall be present when policy is GRANT_RESERVE_SINGLE and an applicable reservation exists. None of these shall be present otherwise. 
  ...
  **/
  ...
  /**
   * Information that identifies a reservation applicable to the network resource requirements of the corresponding grant request. At least one of (computeReservationId, networkReservationId, storageReservationId) shall be present when policy is GRANT_RESERVE_SINGLE and an applicable reservation exists. None of these shall be present otherwise. 
  ...
  **/
  ...
  /**
   * Information that identifies a reservation applicable to the storage resource requirements of the corresponding grant request. At least one of (computeReservationId, networkReservationId, storageReservationId) shall be present when policy is GRANT_RESERVE_SINGLE and an applicable reservation exists. None of these shall be present otherwise. 
