...
import com.ubiqube.etsi.mano.nfvo.v271.model.lcmgrant.GrantRequestLinks;
import com.ubiqube.etsi.mano.nfvo.v271.model.lcmgrant.GrantedLcmOperationType;
import com.ubiqube.etsi.mano.nfvo.v271.model.lcmgrant.KeyValuePairs;
import com.ubiqube.etsi.mano.nfvo.v271.model.lcmgrant.PlacementConstraint;
import com.ubiqube.etsi.mano.nfvo.v271.model.lcmgrant.ResourceDefinition;
import com.ubiqube.etsi.mano.nfvo.v271.model.lcmgrant.VimConstraint;
...
public class GrantRequest   {
  ...
  **/
  ...
  /**
   * Identifier of the VNF deployment flavour of the VNFD that defines the VNF for which the LCM operation is to be granted. Shall be provided when instantiating the VNF or changing the deployment flavour of the VNF instance. 
   * @return flavourId
  **/
  ...
  /**
   * The lifecycle management operation for which granting is requested. The VNF LCM operations CreateVnfIdentifier, DeleteVnfIdentifier, QueryVnf and ModifyVnfInformation can be executed by the VNFM without requesting granting. 
   * @return operation
  **/
  ...
  **/
  ...
  public GrantRequest links(GrantRequestLinks links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public void setLinks(GrantRequestLinks links) {
    this.links = links;
  }
