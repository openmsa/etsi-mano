...
public class PmJobCriteria   {
  ...
  private DateTime2 reportingBoundary = null;
  ...
  **/
  @ApiModelProperty(value = "This defines the types of performance metrics for the specified object instances. Valid values are specified as \"Measurement Name\" values in clause 7.3 of ETSI GS NFV-IFA 027. At least one of the two attributes (performance metric or group) shall be present. ")
  ...
  **/
  ...
  public PmJobCriteria reportingBoundary(DateTime2 reportingBoundary) {
  ...
  **/
  @ApiModelProperty(value = "")
    ...
    @Valid
    public DateTime2 getReportingBoundary() {
    return reportingBoundary;
  }

  public void setReportingBoundary(DateTime2 reportingBoundary) {
    this.reportingBoundary = reportingBoundary;
  }
