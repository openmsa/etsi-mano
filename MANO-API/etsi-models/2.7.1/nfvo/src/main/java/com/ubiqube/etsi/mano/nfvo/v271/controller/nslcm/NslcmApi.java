...
import com.ubiqube.etsi.mano.nfvo.v271.model.nslcm.CancelMode;
...
public interface NslcmApi {
	...
	@RequestMapping(value = "/{nsLcmOpOccId}/cancel", produces = { "application/json" }, consumes = { "application/json" }, method = RequestMethod.POST)
	default ResponseEntity<Void> nslcmV1NsLcmOpOccsNsLcmOpOccIdCancelPost(@ApiParam(value = "Identifier of a NS lifecycle management operation occurrence to be canceled. This identifier can be retrieved from the resource referenced by the \"Location\" HTTP header in the response to a POST request triggering a NS LCM operation. It can also be retrieved from the \"nsLcmOpOccId\" attribute in the NsLcmOperationOccurrenceNotification. ", required = true) @PathVariable("nsLcmOpOccId") final String nsLcmOpOccId, @ApiParam(value = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231 ", required = true) @RequestHeader(value = "Accept", required = true) final String accept, @ApiParam(value = "The MIME type of the body of the request. Reference: IETF RFC 7231 ", required = true) @RequestHeader(value = "Content-Type", required = true) final String contentType, @ApiParam(value = "Version of the API requested to use when responding to this request. ", required = true) @RequestHeader(value = "Version", required = true) final String version,
			@ApiParam(value = "The POST request to this resource shall include a CancelMode structure in the payload body to choose between \"graceful\" and \"forceful\" cancellation. ", required = true) @Valid @RequestBody final CancelMode body, @ApiParam(value = "The authorization token for the request. Reference: IETF RFC 7235 ") @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
		} else {
			log.warn("ObjectMapper or HttpServletRequest not configured in default NslcmApi interface so no example is generated");
		}
		return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
	}

	@ApiOperation(value = "Mark a NS lifecycle management operation occurrence as failed.", nickname = "nslcmV1NsLcmOpOccsNsLcmOpOccIdFailPost", notes = "The POST method marks a NS lifecycle management operation  occurrence as \"finally failed\" if that operation occurrence is in \"FAILED_TEMP\" state. ", response = NsLcmOpOcc.class, tags = {})
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "200 OK Shall be returned when the state of the NS lifecycle management operation occurrence has been changed successfully. The response shall include a representation of the \"Individual NS lifecycle management operation occurrence\" resource. ", response = NsLcmOpOcc.class),
			@ApiResponse(code = 400, message = "400 BAD REQUEST 400 code can be returned in the following specified cases, the specific cause has to be proper specified in the \"ProblemDetails\" structure to be returned. If the request is malformed or syntactically incorrect (e.g. if the request URI contains incorrect query parameters or the payload body contains a syntactically incorrect data structure), the API producer shall respond with this response code. The \"ProblemDetails\" structure shall be provided, and should include in the \"detail\" attribute more information about the source of the problem. If the response to a GET request which queries a container resource would be so big that the performance of the API producer is adversely affected, and the API producer does not support paging for the affected resource, it shall respond with this response code. The \"ProblemDetails\" structure shall be provided, and should include in the \"detail\" attribute more information about the source of the problem. If there is an application error related to the client's input that cannot be easily mapped to any other HTTP response code (\"catch all error\"), the API producer shall respond with this response code. The \"ProblemDetails\" structure shall be provided, and shall include in the \"detail\" attribute more information about the source of the problem. If the request contains a malformed access token, the API producer should respond with this response. The details of the error shall be returned in the WWW Authenticate HTTP header, as defined in IETF RFC 6750 and IETF RFC 7235. The ProblemDetails structure may be provided. The use of this HTTP error response code described above is applicable to the use of the OAuth 2.0 for the authorization of API requests and notifications, as defined in clauses 4.5.3.3 and 4.5.3.4. ", response = ProblemDetails.class),
			@ApiResponse(code = 401, message = "401 UNAUTHORIZED If the request contains no access token even though one is required, or if the request contains an authorization token that is invalid (e.g. expired or revoked), the API producer should respond with this response. The details of the error shall be returned in the WWW-Authenticate HTTP header, as defined in IETF RFC 6750 and IETF RFC 7235. The ProblemDetails structure may be provided. ", response = ProblemDetails.class),
			@ApiResponse(code = 403, message = "403 FORBIDDEN If the API consumer is not allowed to perform a particular request to a particular resource, the API producer shall respond with this response code. The \"ProblemDetails\" structure shall be provided. It should include in the \"detail\" attribute information about the source of the problem, and may indicate how to solve it. ", response = ProblemDetails.class),
			@ApiResponse(code = 404, message = "404 NOT FOUND If the API producer did not find a current representation for the resource addressed by the URI passed in the request or is not willing to disclose that one exists, it shall respond with this response code. The \"ProblemDetails\" structure may be provided, including in the \"detail\" attribute information about the source of the problem, e.g. a wrong resource URI variable. This response code is not appropriate in case the resource addressed by the URI is a container resource which is designed to contain child resources, but does not contain any child resource at the time the request is received. For a GET request to an existing empty container resource, a typical response contains a 200 OK response code and a payload body with an empty array. ", response = ProblemDetails.class),
			...
			@ApiResponse(code = 503, message = "503 SERVICE UNAVAILABLE If the API producer encounters an internal overload situation of itself or of a system it relies on, it should respond with this response code, following the provisions in IETF RFC 7231 for the use of the \"Retry-After\" HTTP header and for the alternative to refuse the connection. The \"ProblemDetails\" structure may be omitted. ", response = ProblemDetails.class),
			@ApiResponse(code = 504, message = "504 GATEWAY TIMEOUT If the API producer encounters a timeout while waiting for a response from an upstream server (i.e. a server that the API producer communicates with when fulfilling a request), it should respond with this response code. ", response = ProblemDetails.class) })
	@RequestMapping(value = "/{nsLcmOpOccId}/fail", produces = { "application/json" }, consumes = { "application/json" }, method = RequestMethod.POST)
	default ResponseEntity<NsLcmOpOcc> nslcmV1NsLcmOpOccsNsLcmOpOccIdFailPost(@ApiParam(value = "Identifier of a NS lifecycle management operation occurrence to be marked as \"failed\". This identifier can be retrieved from the resource referenced by  he \"Location\" HTTP header in the response to a POST request triggering a NS LCM operation.  It can also be retrieved from the \"nsLcmOpOccId\" attribute in the NsLcmOperationOccurrenceNotification. ", required = true) @PathVariable("nsLcmOpOccId") final String nsLcmOpOccId, @ApiParam(value = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231 ", required = true) @RequestHeader(value = "Accept", required = true) final String accept, @ApiParam(value = "Version of the API requested to use when responding to this request. ", required = true) @RequestHeader(value = "Version", required = true) final String version, @ApiParam(value = "The authorization token for the request. Reference: IETF RFC 7235 ") @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
					return new ResponseEntity<>(getObjectMapper().get().readValue(
							"{  \"_links\" : {    \"cancel\" : {      \"href\" : \"http://example.com/aeiou\"    },    \"rollback\" : {      \"href\" : \"http://example.com/aeiou\"    },    \"fail\" : {      \"href\" : \"http://example.com/aeiou\"    },    \"continue\" : {      \"href\" : \"http://example.com/aeiou\"    },    \"nsInstance\" : {      \"href\" : \"http://example.com/aeiou\"    },    \"self\" : {      \"href\" : \"http://example.com/aeiou\"    },    \"retry\" : {      \"href\" : \"http://example.com/aeiou\"    }  },  \"lcmOperationType\" : { },  \"operationState\" : { },  \"error\" : {    \"instance\" : \"instance\",    \"detail\" : \"detail\",    \"type\" : \"type\",    \"title\" : \"title\",    \"status\" : 0  },  \"resourceChanges\" : {    \"affectedNss\" : [ {      \"changeResult\" : \"COMPLETED\",      \"changeType\" : \"ADD\"    }, {      \"changeResult\" : \"COMPLETED\",      \"changeType\" : \"ADD\"    } ],    \"affectedVnfs\" : [ {      \"changeResult\" : \"COMPLETED\",      \"changeType\" : \"ADD\",      \"changedInfo\" : {        \"changedExtConnectivity\" : {          \"resourceHandle\" : {            \"vimLevelResourceType\" : \"vimLevelResourceType\"          },          \"extLinkPorts\" : [ {            \"resourceHandle\" : {              \"vimLevelResourceType\" : \"vimLevelResourceType\"            }          }, {            \"resourceHandle\" : {              \"vimLevelResourceType\" : \"vimLevelResourceType\"            }          } ]        },        \"changedVnfInfo\" : {          \"vnfInstanceName\" : \"vnfInstanceName\",          \"vnfInstanceDescription\" : \"vnfInstanceDescription\"        }      },      \"vnfProfileId\" : { },      \"vnfName\" : \"vnfName\"    }, {      \"changeResult\" : \"COMPLETED\",      \"changeType\" : \"ADD\",      \"changedInfo\" : {        \"changedExtConnectivity\" : {          \"resourceHandle\" : {            \"vimLevelResourceType\" : \"vimLevelResourceType\"          },          \"extLinkPorts\" : [ {            \"resourceHandle\" : {              \"vimLevelResourceType\" : \"vimLevelResourceType\"            }          }, {            \"resourceHandle\" : {              \"vimLevelResourceType\" : \"vimLevelResourceType\"            }          } ]        },        \"changedVnfInfo\" : {          \"vnfInstanceName\" : \"vnfInstanceName\",          \"vnfInstanceDescription\" : \"vnfInstanceDescription\"        }      },      \"vnfProfileId\" : { },      \"vnfName\" : \"vnfName\"    } ],    \"affectedPnfs\" : [ {      \"pnfName\" : \"pnfName\",      \"changeResult\" : \"COMPLETED\",      \"changeType\" : \"ADD\",      \"cpInstanceId\" : [ { }, { } ]    }, {      \"pnfName\" : \"pnfName\",      \"changeResult\" : \"COMPLETED\",      \"changeType\" : \"ADD\",      \"cpInstanceId\" : [ { }, { } ]    } ],    \"affectedVnffgs\" : [ {      \"changeResult\" : \"COMPLETED\",      \"changeType\" : \"ADD\",      \"vnffgInstanceId\" : { }    }, {      \"changeResult\" : \"COMPLETED\",      \"changeType\" : \"ADD\",      \"vnffgInstanceId\" : { }    } ],    \"affectedVls\" : [ {      \"metadata\" : { },      \"networkResource\" : {        \"vimLevelResourceType\" : \"vimLevelResourceType\"      },      \"changeType\" : \"ADDED\",      \"virtualLinkDescId\" : { },      \"id\" : { }    }, {      \"metadata\" : { },      \"networkResource\" : {        \"vimLevelResourceType\" : \"vimLevelResourceType\"      },      \"changeType\" : \"ADDED\",      \"virtualLinkDescId\" : { },      \"id\" : { }    } ],    \"affectedSaps\" : [ {      \"changeResult\" : \"COMPLETED\",      \"changeType\" : \"ADD\",      \"sapName\" : \"sapName\"    }, {      \"changeResult\" : \"COMPLETED\",      \"changeType\" : \"ADD\",      \"sapName\" : \"sapName\"    } ]  },  \"cancelMode\" : { },  \"operationParams\" : \"INSTANTIATE\",  \"id\" : { },  \"isAutomaticInvocation\" : true,  \"isCancelPending\" : true,  \"statusEnteredTime\" : { }}",
							NsLcmOpOcc.class), HttpStatus.NOT_IMPLEMENTED);
