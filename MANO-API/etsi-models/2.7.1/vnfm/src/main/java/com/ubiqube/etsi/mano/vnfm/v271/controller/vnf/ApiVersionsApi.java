...
import com.ubiqube.etsi.mano.vnfm.v271.model.vnf.ApiVersionInformation;
...
public interface ApiVersionsApi {
	...
	@ApiResponses(value = {
			...
			@ApiResponse(code = 405, message = "405 METHOD NOT ALLOWED If a particular HTTP method is not supported for a particular resource, the API producer shall respond with this response code. The \"ProblemDetails\" structure may be omitted. "),
			@ApiResponse(code = 406, message = "406 NOT ACCEPTABLE If the \"Accept\" HTTP header does not contain at least one name of a content type that is acceptable to the API producer, the API producer shall respond with this response code. The \"ProblemDetails\" structure may be omitted. "),
			...
			@ApiResponse(code = 416, message = "416 Range Not Satisfiable "),
	...
	default ResponseEntity<ApiVersionInformation> apiVersionsGet(@ApiParam(value = "Version of the API requested to use when responding to this request. ") @RequestHeader(value = "Version", required = false) final String version) {
