...
import com.ubiqube.etsi.mano.vnfm.v271.model.vnflcm.LccnSubscriptionLinks;
...
public class VnfLcmSubscriptions271Sol003Controller implements VnfLcmSubscriptions271Sol003Api {
	...
	public ResponseEntity<LccnSubscription> subscriptionsSubscriptionIdGet(final String subscriptionId) {
		return frontController.findById(getSafeUUID(subscriptionId), LccnSubscription.class, VnfLcmSubscriptions271Sol003Controller::makeLinks);
	}
