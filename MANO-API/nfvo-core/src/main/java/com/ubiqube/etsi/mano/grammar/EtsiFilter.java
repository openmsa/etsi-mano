...
public class EtsiFilter extends Parser {
	...
	public static final int RULE_simpleFilterExpr = 0, RULE_filterExpr = 1, RULE_op = 2, RULE_attrName = 3,
			RULE_value = 4;
	...
	public EtsiFilter(final TokenStream input) {
		super(input);
	...
	public static class SimpleFilterExprContext extends ParserRuleContext {
		...
		public TerminalNode EQUAL() {
			return getToken(EtsiFilter.EQUAL, 0);
		}
		...
		public List<TerminalNode> DOT() {
			return getTokens(EtsiFilter.DOT);
		}
		...
		public List<TerminalNode> COMMA() {
			return getTokens(EtsiFilter.COMMA);
		}
		...
		public void enterRule(final ParseTreeListener listener) {
			if (listener instanceof EtsiFilterListener) {
				((EtsiFilterListener) listener).enterSimpleFilterExpr(this);
			}
		}
		...
		public void exitRule(final ParseTreeListener listener) {
			if (listener instanceof EtsiFilterListener) {
				((EtsiFilterListener) listener).exitSimpleFilterExpr(this);
			}
		}
	}
	...
	public static class FilterExprContext extends ParserRuleContext {
		...
		public List<TerminalNode> AMPERSAND() {
			return getTokens(EtsiFilter.AMPERSAND);
		}

		public TerminalNode AMPERSAND(final int i) {
		...
		public void enterRule(final ParseTreeListener listener) {
			if (listener instanceof EtsiFilterListener) {
				((EtsiFilterListener) listener).enterFilterExpr(this);
			}
		}
		...
		public void exitRule(final ParseTreeListener listener) {
			if (listener instanceof EtsiFilterListener) {
				((EtsiFilterListener) listener).exitFilterExpr(this);
			}
		}
	}
	...
	public static class OpContext extends ParserRuleContext {
		public TerminalNode EQ() {
			return getToken(EtsiFilter.EQ, 0);
		}

		public TerminalNode NEQ() {
			return getToken(EtsiFilter.NEQ, 0);
		}

		public TerminalNode GT() {
			return getToken(EtsiFilter.GT, 0);
		}

		public TerminalNode LT() {
			return getToken(EtsiFilter.LT, 0);
		}

		public TerminalNode GTE() {
			return getToken(EtsiFilter.GTE, 0);
		}

		public TerminalNode LTE() {
			return getToken(EtsiFilter.LTE, 0);
		}

		public TerminalNode CONT() {
			return getToken(EtsiFilter.CONT, 0);
		}

		public TerminalNode NCONT() {
			return getToken(EtsiFilter.NCONT, 0);
		}

		public OpContext(final ParserRuleContext parent, final int invokingState) {
			super(parent, invokingState);
		}
		...
		public void enterRule(final ParseTreeListener listener) {
			if (listener instanceof EtsiFilterListener) {
				((EtsiFilterListener) listener).enterOp(this);
			}
		}
		...
		public void exitRule(final ParseTreeListener listener) {
			if (listener instanceof EtsiFilterListener) {
				((EtsiFilterListener) listener).exitOp(this);
			}
		}
	}

	public final OpContext op() throws RecognitionException {
		final OpContext _localctx = new OpContext(_ctx, getState());
	...
	public static class AttrNameContext extends ParserRuleContext {
		public TerminalNode ATTRIBUTE() {
			return getToken(EtsiFilter.ATTRIBUTE, 0);
		}
		...
		public void enterRule(final ParseTreeListener listener) {
			if (listener instanceof EtsiFilterListener) {
				((EtsiFilterListener) listener).enterAttrName(this);
			}
		}
		...
		public void exitRule(final ParseTreeListener listener) {
			if (listener instanceof EtsiFilterListener) {
				((EtsiFilterListener) listener).exitAttrName(this);
			}
		}
	}
	...
	public static class ValueContext extends ParserRuleContext {
		public TerminalNode STRING() {
			return getToken(EtsiFilter.STRING, 0);
		}
		...
		public void enterRule(final ParseTreeListener listener) {
			if (listener instanceof EtsiFilterListener) {
				((EtsiFilterListener) listener).enterValue(this);
			}
		}
		...
		public void exitRule(final ParseTreeListener listener) {
			if (listener instanceof EtsiFilterListener) {
				((EtsiFilterListener) listener).exitValue(this);
			}
		}
	}
	...
	public static final String _serializedATN = "\3\u608b\ua72a\u8133\ub9ed\u417c\u3be7\u7786\u5964\3\27\60\4\2\t\2\4\3" +
