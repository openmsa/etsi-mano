...
public interface AppInstancesApi {
    ...
    @RequestMapping(value = "/app_instances", produces = { "application/json" }, method = RequestMethod.GET)
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 429, message = "Too Many Requests : used when a rate limiter has triggered.", response = ProblemDetails.class) })
    @RequestMapping(value = "/app_instances/{appInstanceId}", produces = { "application/json" }, method = RequestMethod.DELETE)
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 406, message = "Not Acceptable : used to indicate that the server cannot provide the any of the content formats supported by the client.", response = ProblemDetails.class),
            @ApiResponse(code = 429, message = "Too Many Requests : used when a rate limiter has triggered.", response = ProblemDetails.class) })
    @RequestMapping(value = "/app_instances/{appInstanceId}", produces = { "application/json" }, method = RequestMethod.GET)
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 406, message = "Not Acceptable : used to indicate that the server cannot provide the any of the content formats supported by the client.", response = ProblemDetails.class),
            @ApiResponse(code = 429, message = "Too Many Requests : used when a rate limiter has triggered.", response = ProblemDetails.class) })
    @RequestMapping(value = "/app_instances", produces = { "application/zip", "application/json" }, consumes = { "application/json" }, method = RequestMethod.POST)
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 409, message = "Conflict : The operation cannot be executed currently, due to a conflict with the state of the resource", response = ProblemDetails.class),
            @ApiResponse(code = 429, message = "Too Many Requests : used when a rate limiter has triggered.", response = ProblemDetails.class) })
    @RequestMapping(value = "/app_instances/{appInstanceId}/instantiate", produces = { "application/json" }, consumes = { "application/json" }, method = RequestMethod.POST)
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 409, message = "Conflict : The operation cannot be executed currently, due to a conflict with the state of the resource", response = ProblemDetails.class),
            @ApiResponse(code = 429, message = "Too Many Requests : used when a rate limiter has triggered.", response = ProblemDetails.class) })
    @RequestMapping(value = "/app_instances/{appInstanceId}/operate", produces = { "application/json" }, consumes = { "application/json" }, method = RequestMethod.POST)
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 409, message = "Conflict : The operation cannot be executed currently, due to a conflict with the state of the resource", response = ProblemDetails.class),
            @ApiResponse(code = 429, message = "Too Many Requests : used when a rate limiter has triggered.", response = ProblemDetails.class) })
    @RequestMapping(value = "/app_instances/{appInstanceId}/terminate", produces = { "application/json" }, consumes = { "application/json" }, method = RequestMethod.POST)
